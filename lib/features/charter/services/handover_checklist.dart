...
const List<HandoverCategoryDef> checkInCategories = [
  HandoverCategoryDef('electrical', 'Elektrické vybavenie', 'Electrical equipment',
    ...
    HandoverItemDef('electrical_switches', 'Vypínače a ističe', 'Switches and breakers',
        ...
        labelCs: 'Vypínače a jističe', labelPl: 'Wyłączniki i bezpieczniki', labelEl: 'Διακόπτες και ασφάλειες', labelHr: 'Prekidači i osigurači', labelSl: 'Stikala in odklopniki'),
    HandoverItemDef('electrical_windlass', 'Kotvový naviják (ankerspill)', 'Anchor windlass',
        ...
        labelCs: 'Kotevní naviják', labelPl: 'Winda kotwiczna', labelEl: 'Εργάτης άγκυρας', labelHr: 'Sidreno vitlo', labelSl: 'Sidrno vitlo'),
    HandoverItemDef('electrical_nav_instruments', 'Navigačné prístroje', 'Navigation instruments',
        ...
        labelCs: 'Navigační přístroje', labelPl: 'Przyrządy nawigacyjne', labelEl: 'Όργανα ναυσιπλοΐας', labelHr: 'Navigacijski instrumenti', labelSl: 'Navigacijski instrumenti'),
    HandoverItemDef('electrical_vhf', 'VHF rádio', 'VHF radio',
        'UKW-Funkgerät', 'Radio VHF', 'Радіостанція VHF',
        labelCs: 'VHF rádio', labelPl: 'Radio VHF', labelEl: 'Ασύρματος VHF', labelHr: 'VHF radio', labelSl: 'Radio VHF'),
    HandoverItemDef('electrical_battery_indicator', 'Indikátor stavu batérie', 'Battery status indicator',
        ...
        labelCs: 'Indikátor stavu baterie', labelPl: 'Wskaźnik stanu akumulatora', labelEl: 'Δείκτης κατάστασης μπαταρίας', labelHr: 'Pokazivač stanja baterije', labelSl: 'Kazalnik stanja akumulatorja'),
    HandoverItemDef('electrical_nav_lights', 'Pozičné svetlá', 'Navigation lights',
        'Positionslichter', 'Luces de navegación', 'Ходові вогні',
        labelCs: 'Poziční světla', labelPl: 'Światła nawigacyjne', labelEl: 'Φώτα ναυσιπλοΐας', labelHr: 'Navigacijska svjetla', labelSl: 'Navigacijske luči'),
    HandoverItemDef('electrical_autopilot', 'Autopilot', 'Autopilot',
        'Autopilot', 'Piloto automático', 'Автопілот',
        labelCs: 'Autopilot', labelPl: 'Autopilot', labelEl: 'Αυτόματος πιλότος', labelHr: 'Autopilot', labelSl: 'Avtopilot'),
    HandoverItemDef('electrical_fuses', 'Poistky', 'Fuses',
        'Sicherungen', 'Fusibles', 'Запобіжники',
        labelCs: 'Pojistky', labelPl: 'Bezpieczniki', labelEl: 'Ασφάλειες', labelHr: 'Osigurači', labelSl: 'Varovalke'),
    HandoverItemDef('electrical_water_level', 'Indikátor hladiny vody', 'Water level indicator',
        ...
        labelCs: 'Indikátor hladiny vody', labelPl: 'Wskaźnik poziomu wody', labelEl: 'Δείκτης στάθμης νερού', labelHr: 'Pokazivač razine vode', labelSl: 'Kazalnik ravni vode'),
    HandoverItemDef('electrical_spare_bulbs', 'Náhradné žiarovky', 'Spare bulbs',
        ...
        labelCs: 'Náhradní žárovky', labelPl: 'Zapasowe żarówki', labelEl: 'Εφεδρικοί λαμπτήρες', labelHr: 'Rezervne žarulje', labelSl: 'Rezervne žarnice'),
    HandoverItemDef('electrical_depth_sounder', 'Lodný sonar (merač hĺbky)', 'Depth sounder',
        'Echolot', 'Sonda de profundidad', 'Ехолот',
        labelCs: 'Lodní sonar (měřič hloubky)', labelPl: 'Echosonda (głębokościomierz)', labelEl: 'Βυθόμετρο', labelHr: 'Dubinomjer', labelSl: 'Globinomer'),
    HandoverItemDef('electrical_pumps', 'Čerpadlá (pumpy)', 'Pumps',
        'Pumpen', 'Bombas', 'Помпи',
        labelCs: 'Čerpadla (pumpy)', labelPl: 'Pompy', labelEl: 'Αντλίες', labelHr: 'Pumpe', labelSl: 'Črpalke'),
  ], labelCs: 'Elektrické vybavení', labelPl: 'Wyposażenie elektryczne', labelEl: 'Ηλεκτρολογικός εξοπλισμός', labelHr: 'Električna oprema', labelSl: 'Električna oprema'),
  HandoverCategoryDef('engine', 'Motor a palivo', 'Engine and fuel',
    ...
    HandoverItemDef('engine_refuel', 'Dotankovanie', 'Refuelling',
        ...
        labelCs: 'Dotankování', labelPl: 'Tankowanie', labelEl: 'Ανεφοδιασμός καυσίμου', labelHr: 'Punjenje goriva', labelSl: 'Dotakanje goriva'),
    HandoverItemDef('engine_vbelt', 'Napnutie V-remeňov', 'V-belt tension',
        ...
        labelCs: 'Napnutí klínových řemenů', labelPl: 'Napięcie pasków klinowych', labelEl: 'Τάση τραπεζοειδών ιμάντων', labelHr: 'Napetost klinastog remena', labelSl: 'Napetost klinastega jermena'),
    HandoverItemDef('engine_cooling_water', 'Kontrola prívodu chladiacej vody', 'Cooling water intake check',
        ...
        labelCs: 'Kontrola přívodu chladicí vody', labelPl: 'Kontrola dopływu wody chłodzącej', labelEl: 'Έλεγχος εισαγωγής νερού ψύξης', labelHr: 'Provjera dovoda rashladne vode', labelSl: 'Pregled dovoda hladilne vode'),
    HandoverItemDef('engine_oil', 'Motorový olej', 'Engine oil',
        'Motoröl', 'Aceite del motor', 'Моторна олива',
        labelCs: 'Motorový olej', labelPl: 'Olej silnikowy', labelEl: 'Λάδι μηχανής', labelHr: 'Motorno ulje', labelSl: 'Motorno olje'),
    HandoverItemDef('engine_fuel_filter', 'Palivový filter', 'Fuel filter',
        'Kraftstofffilter', 'Filtro de combustible', 'Паливний фільтр',
        labelCs: 'Palivový filtr', labelPl: 'Filtr paliwa', labelEl: 'Φίλτρο καυσίμου', labelHr: 'Filtar goriva', labelSl: 'Filter goriva'),
    HandoverItemDef('engine_fuel_level', 'Hladina paliva v nádrži', 'Fuel tank level',
        ...
        labelCs: 'Hladina paliva v nádrži', labelPl: 'Poziom paliwa w zbiorniku', labelEl: 'Στάθμη καυσίμου στη δεξαμενή', labelHr: 'Razina u tanku goriva', labelSl: 'Raven v rezervoarju goriva'),
    HandoverItemDef('engine_gearbox_oil', 'Olej v prevodovke', 'Gearbox oil',
        'Getriebeöl', 'Aceite de la transmisión', 'Олива в редукторі',
        labelCs: 'Olej v převodovce', labelPl: 'Olej w przekładni', labelEl: 'Λάδι κιβωτίου ταχυτήτων', labelHr: 'Ulje u reduktoru', labelSl: 'Olje v menjalniku'),
    HandoverItemDef('engine_coolant_level', 'Hladina chladiacej kvapaliny', 'Coolant level',
        ...
        labelCs: 'Hladina chladicí kapaliny', labelPl: 'Poziom płynu chłodzącego', labelEl: 'Στάθμη ψυκτικού υγρού', labelHr: 'Razina rashladne tekućine', labelSl: 'Raven hladilne tekočine'),
    HandoverItemDef('engine_fuel_tank_condition', 'Kontrola stavu palivovej nádrže a jej upevnenia',
        ...
        labelCs: 'Kontrola stavu palivové nádrže a jejího upevnění', labelPl: 'Kontrola stanu i mocowania zbiornika paliwa', labelEl: 'Έλεγχος κατάστασης και στερέωσης δεξαμενής καυσίμου', labelHr: 'Provjera stanja i učvršćenja tanka goriva', labelSl: 'Pregled stanja in pritrditve rezervoarja goriva'),
  ], labelCs: 'Motor a palivo', labelPl: 'Silnik i paliwo', labelEl: 'Μηχανή και καύσιμο', labelHr: 'Motor i gorivo', labelSl: 'Motor in gorivo'),
  HandoverCategoryDef('nav_docs', 'Navigačné pomôcky a doklady', 'Navigation aids and documents',
    ...
    HandoverItemDef('nav_docs_paper_charts', 'Papierové mapy a navigácia', 'Paper charts and navigation',
        ...
        labelCs: 'Papírové mapy a navigace', labelPl: 'Mapy papierowe i nawigacja', labelEl: 'Χάρτινοι χάρτες και ναυσιπλοΐα', labelHr: 'Papirnate karte i navigacija', labelSl: 'Papirnate karte in navigacija'),
    HandoverItemDef('nav_docs_sailing_permit', 'Povolenie na plavbu (sailing permit)', 'Sailing permit',
        ...
        labelCs: 'Povolení k plavbě (sailing permit)', labelPl: 'Zezwolenie na żeglugę (sailing permit)', labelEl: 'Άδεια πλου (sailing permit)', labelHr: 'Dozvola za plovidbu', labelSl: 'Dovoljenje za plovbo'),
    HandoverItemDef('nav_docs_aids', 'Navigačné pomôcky', 'Navigation aids',
        ...
        labelCs: 'Navigační pomůcky', labelPl: 'Pomoce nawigacyjne', labelEl: 'Ναυτιλιακά βοηθήματα', labelHr: 'Navigacijska pomagala', labelSl: 'Navigacijski pripomočki'),
    HandoverItemDef('nav_docs_crew_list', 'Zoznam posádky (crew list)', 'Crew list',
        'Crew-Liste', 'Lista de tripulación', 'Список екіпажу',
        labelCs: 'Seznam posádky (crew list)', labelPl: 'Lista załogi (crew list)', labelEl: 'Κατάσταση πληρώματος (crew list)', labelHr: 'Popis posade', labelSl: 'Seznam posadke'),
    HandoverItemDef('nav_docs_binoculars', 'Ďalekohľad', 'Binoculars',
        'Fernglas', 'Prismáticos', 'Бінокль',
        labelCs: 'Dalekohled', labelPl: 'Lornetka', labelEl: 'Κιάλια', labelHr: 'Dalekozor', labelSl: 'Daljnogled'),
  ], labelCs: 'Navigační pomůcky a doklady', labelPl: 'Pomoce nawigacyjne i dokumenty', labelEl: 'Ναυτιλιακά βοηθήματα και έγγραφα', labelHr: 'Navigacijska pomagala i dokumenti', labelSl: 'Navigacijski pripomočki in dokumenti'),
  HandoverCategoryDef('hull', 'Trup lode', 'Hull',
      'Rumpf', 'Casco', 'Корпус', [
    HandoverItemDef('hull_deck', 'Paluba lode', 'Deck',
        'Deck', 'Cubierta', 'Палуба',
        labelCs: 'Paluba lodi', labelPl: 'Pokład', labelEl: 'Κατάστρωμα', labelHr: 'Paluba', labelSl: 'Krov'),
    HandoverItemDef('hull_bow', 'Prova lode', 'Bow',
        'Bug', 'Proa', 'Ніс судна',
        labelCs: 'Příď lodi', labelPl: 'Dziób', labelEl: 'Πλώρη', labelHr: 'Pramac', labelSl: 'Premec'),
    HandoverItemDef('hull_under_floorboards', 'Priestor pod palubovými doskami', 'Space under the floorboards',
        ...
        labelCs: 'Prostor pod podlahovými deskami', labelPl: 'Przestrzeń pod podłogami', labelEl: 'Χώρος κάτω από τα δάπεδα', labelHr: 'Prostor ispod podnica', labelSl: 'Prostor pod podnicami'),
    HandoverItemDef('hull_stern', 'Záď lode', 'Stern',
        'Heck', 'Popa', 'Корма',
        labelCs: 'Záď lodi', labelPl: 'Rufa', labelEl: 'Πρύμνη', labelHr: 'Krma', labelSl: 'Krma'),
    HandoverItemDef('hull_sides', 'Boky lode', 'Hull sides',
        'Rumpfseiten', 'Costados del casco', 'Борти корпусу',
        labelCs: 'Boky lodi', labelPl: 'Burty', labelEl: 'Πλευρές γάστρας', labelHr: 'Bokovi trupa', labelSl: 'Boki trupa'),
    HandoverItemDef('hull_underwater', 'Podvodná časť trupu', 'Underwater part of the hull',
        ...
        labelCs: 'Podvodní část trupu', labelPl: 'Podwodna część kadłuba', labelEl: 'Ύφαλο τμήμα γάστρας', labelHr: 'Podvodni dio trupa', labelSl: 'Podvodni del trupa'),
  ], labelCs: 'Trup lodi', labelPl: 'Kadłub', labelEl: 'Γάστρα', labelHr: 'Trup', labelSl: 'Trup'),
  HandoverCategoryDef('safety_gear', 'Bezpečnostné vybavenie', 'Safety equipment',
    ...
    HandoverItemDef('safety_gear_life_jackets', 'Záchranné vesty', 'Life jackets',
        ...
        labelCs: 'Záchranné vesty', labelPl: 'Kamizelki ratunkowe', labelEl: 'Σωσίβια', labelHr: 'Prsluci za spašavanje', labelSl: 'Rešilni jopiči'),
    HandoverItemDef('safety_gear_extinguishers', 'Hasiace prístroje', 'Fire extinguishers',
        'Feuerlöscher', 'Extintores', 'Вогнегасники',
        labelCs: 'Hasicí přístroje', labelPl: 'Gaśnice', labelEl: 'Πυροσβεστήρες', labelHr: 'Vatrogasni aparati', labelSl: 'Gasilni aparati'),
    HandoverItemDef('safety_gear_harnesses', 'Bezpečnostné postroje', 'Safety harnesses',
        ...
        labelCs: 'Bezpečnostní postroje', labelPl: 'Uprzęże bezpieczeństwa', labelEl: 'Ζώνες ασφαλείας', labelHr: 'Sigurnosni pojasevi', labelSl: 'Varnostni pasovi'),
    HandoverItemDef('safety_gear_flares', 'Svetlice', 'Flares',
        'Signalraketen', 'Bengalas', 'Сигнальні ракети',
        labelCs: 'Světlice', labelPl: 'Rakiety sygnałowe', labelEl: 'Φωτοβολίδες', labelHr: 'Signalne rakete', labelSl: 'Signalne rakete'),
  ], labelCs: 'Bezpečnostní vybavení', labelPl: 'Sprzęt bezpieczeństwa', labelEl: 'Εξοπλισμός ασφαλείας', labelHr: 'Sigurnosna oprema', labelSl: 'Varnostna oprema'),
  HandoverCategoryDef('galley', 'Kuchyňa', 'Galley',
    ...
    HandoverItemDef('galley_fridge', 'Chladnička', 'Fridge',
        ...
        labelCs: 'Lednička', labelPl: 'Lodówka', labelEl: 'Ψυγείο', labelHr: 'Hladnjak', labelSl: 'Hladilnik'),
    HandoverItemDef('galley_gas_shutoff', 'Hlavný plynový uzáver', 'Main gas shut-off valve',
        ...
        labelCs: 'Hlavní plynový uzávěr', labelPl: 'Główny zawór gazu', labelEl: 'Κεντρική βαλβίδα αερίου', labelHr: 'Glavni zaporni ventil plina', labelSl: 'Glavni zaporni ventil plina'),
    HandoverItemDef('galley_stove', 'Sporák a jeho upevnenie', 'Stove and its mounting',
        ...
        labelCs: 'Sporák a jeho upevnění', labelPl: 'Kuchenka i jej mocowanie', labelEl: 'Εστία και η στερέωσή της', labelHr: 'Štednjak i njegovo učvršćenje', labelSl: 'Štedilnik in njegova pritrditev'),
    HandoverItemDef('galley_gas_bottles', 'Plynové fľaše (2 ks)', 'Gas bottles (2 pcs)',
        ...
        labelCs: 'Plynové lahve (2 ks)', labelPl: 'Butle gazowe (2 szt.)', labelEl: 'Φιάλες αερίου (2 τεμ.)', labelHr: 'Plinske boce (2 kom)', labelSl: 'Plinske jeklenke (2 kos)'),
  ], labelCs: 'Kuchyně', labelPl: 'Kambuz', labelEl: 'Μαγειρείο', labelHr: 'Brodska kuhinja', labelSl: 'Ladijska kuhinja'),
  HandoverCategoryDef('cabins', 'Kajuty', 'Cabins',
    ...
    HandoverItemDef('cabins_bedding', 'Posteľná bielizeň', 'Bedding',
        ...
        labelCs: 'Ložní prádlo', labelPl: 'Pościel', labelEl: 'Κλινοσκεπάσματα', labelHr: 'Posteljina', labelSl: 'Posteljnina'),
    HandoverItemDef('cabins_storage', 'Úložné priestory', 'Storage spaces',
        'Stauräume', 'Espacios de almacenamiento', 'Місця зберігання',
        labelCs: 'Úložné prostory', labelPl: 'Schowki', labelEl: 'Αποθηκευτικοί χώροι', labelHr: 'Prostori za odlaganje', labelSl: 'Odlagalni prostori'),
  ], labelCs: 'Kajuty', labelPl: 'Kabiny', labelEl: 'Καμπίνες', labelHr: 'Kabine', labelSl: 'Kabine'),
  HandoverCategoryDef('water_heads', 'Voda, WC a kúpeľne', 'Water, heads and bathrooms',
    ...
    HandoverItemDef('water_heads_tanks', 'Vodné nádrže', 'Water tanks',
        ...
        labelCs: 'Vodní nádrže', labelPl: 'Zbiorniki wody', labelEl: 'Δεξαμενές νερού', labelHr: 'Tankovi vode', labelSl: 'Rezervoarji vode'),
    HandoverItemDef('water_heads_toilet_valves', 'WC (ventily)', 'Toilet (valves)',
        'WC (Ventile)', 'Inodoro (válvulas)', 'Гальюн (клапани)',
        labelCs: 'WC (ventily)', labelPl: 'WC (zawory)', labelEl: 'Τουαλέτα (βαλβίδες)', labelHr: 'Toalet (ventili)', labelSl: 'Stranišče (ventili)'),
    HandoverItemDef('water_heads_shower_pump', 'Čerpanie vody zo sprchovej vaničky', 'Shower sump pump',
        ...
        labelCs: 'Čerpání vody ze sprchové vaničky', labelPl: 'Pompa brodzika prysznicowego', labelEl: 'Αντλία λεκάνης ντους', labelHr: 'Pumpa kaljuže tuša', labelSl: 'Črpalka kaluže tuša'),
    HandoverItemDef('water_heads_waste_tank', 'Prepnutie odpadovej nádrže a vypustenie',
        ...
        labelCs: 'Přepnutí odpadní nádrže a vypuštění', labelPl: 'Przełączenie i opróżnienie zbiornika fekaliów', labelEl: 'Εναλλαγή και εκκένωση δεξαμενής λυμάτων', labelHr: 'Preusmjeravanje i pražnjenje fekalnog tanka', labelSl: 'Preusmeritev in praznjenje fekalnega rezervoarja'),
    HandoverItemDef('water_heads_transom_shower', 'Zadná sprcha', 'Transom shower',
        'Heckdusche', 'Ducha de popa', 'Кормовий душ',
        labelCs: 'Zadní sprcha', labelPl: 'Prysznic rufowy', labelEl: 'Ντους πρύμνης', labelHr: 'Tuš na krmenom zrcalu', labelSl: 'Tuš na krmnem zrcalu'),
  ], labelCs: 'Voda, WC a koupelny', labelPl: 'Woda, WC i łazienki', labelEl: 'Νερό, τουαλέτες και μπάνια', labelHr: 'Voda, toaleti i kupaonice', labelSl: 'Voda, stranišča in kopalnice'),
  HandoverCategoryDef('sails_steering', 'Plachty a kormidlovanie', 'Sails and steering',
    ...
    HandoverItemDef('sails_steering_reefing', 'Balenie a reefovanie plachiet – napnutie lán',
        ...
        labelCs: 'Balení a refování plachet – napnutí lan', labelPl: 'Zwijanie i refowanie żagli – napięcie lin', labelEl: 'Μάζεμα και μούδα πανιών – τάση σχοινιών', labelHr: 'Namotavanje i kraćenje jedara – napetost konopa', labelSl: 'Navijanje in krajšanje jader – napetost vrvi'),
    HandoverItemDef('sails_steering_halyards', 'Stav halyárd (zdvíhacích lán)', 'Halyard condition',
        ...
        labelCs: 'Stav vytahovacích lan (fal)', labelPl: 'Stan falów', labelEl: 'Κατάσταση μαντάρων', labelHr: 'Stanje podigača', labelSl: 'Stanje dvižnih vrvi'),
    HandoverItemDef('sails_steering_rudder', 'Kormidlo', 'Rudder',
        'Ruder', 'Timón', 'Кермо',
        labelCs: 'Kormidlo', labelPl: 'Ster', labelEl: 'Πηδάλιο', labelHr: 'Kormilo', labelSl: 'Krmilo'),
    HandoverItemDef('sails_steering_stoppers', 'Stopéry', 'Rope clutches',
        'Fallenstopper', 'Mordazas', 'Стопори',
        labelCs: 'Stopéry', labelPl: 'Stopery lin', labelEl: 'Στόπερ σχοινιών', labelHr: 'Stoperi konopa', labelSl: 'Zaskočke vrvi'),
    HandoverItemDef('sails_steering_furling_gear', 'Stav navíjacích zariadení (furling)', 'Furling gear condition',
        ...
        labelCs: 'Stav navíjecích zařízení (furling)', labelPl: 'Stan urządzeń zwijających (furling)', labelEl: 'Κατάσταση συστημάτων περιτύλιξης (furling)', labelHr: 'Stanje sustava za namotavanje', labelSl: 'Stanje sistema za navijanje'),
    HandoverItemDef('sails_steering_sails', 'Stav plachiet', 'Sail condition',
        'Zustand der Segel', 'Estado de las velas', 'Стан вітрил',
        labelCs: 'Stav plachet', labelPl: 'Stan żagli', labelEl: 'Κατάσταση πανιών', labelHr: 'Stanje jedara', labelSl: 'Stanje jader'),
    HandoverItemDef('sails_steering_winches', 'Winche', 'Winches',
        'Winschen', 'Winches', 'Лебідки',
        labelCs: 'Winše', labelPl: 'Kabestany (winsze)', labelEl: 'Βίντσια', labelHr: 'Vinčevi', labelSl: 'Vinči'),
    HandoverItemDef('sails_steering_sheets', 'Stav šotových lán', 'Sheet condition',
        ...
        labelCs: 'Stav škotových lan', labelPl: 'Stan szotów', labelEl: 'Κατάσταση σχοινιών (σκότες)', labelHr: 'Stanje škota', labelSl: 'Stanje škot'),
  ], labelCs: 'Plachty a kormidlování', labelPl: 'Żagle i sterowanie', labelEl: 'Πανιά και πηδάλιο', labelHr: 'Jedra i kormilarenje', labelSl: 'Jadra in krmiljenje'),
  HandoverCategoryDef('often_forgotten', 'Často zabudnuté', 'Often forgotten',
    ...
    HandoverItemDef('often_forgotten_bosun_chair_ladder', 'Bosunov rebrík na lezenie na sťažeň',
        ...
        labelCs: 'Žebřík na lezení na stěžeň', labelPl: 'Drabinka do wchodzenia na maszt', labelEl: 'Σκάλα ανάβασης στον ιστό', labelHr: 'Ljestve za penjanje na jarbol', labelSl: 'Lestev za vzpon na jambor'),
    HandoverItemDef('often_forgotten_spare_vbelt', 'Náhradné V-remene pre hlavný motor',
        ...
        labelCs: 'Náhradní klínové řemeny pro hlavní motor', labelPl: 'Zapasowe paski klinowe do silnika głównego', labelEl: 'Εφεδρικοί ιμάντες για την κύρια μηχανή', labelHr: 'Rezervni klinasti remeni za glavni motor', labelSl: 'Rezervni klinasti jermeni za glavni motor'),
    HandoverItemDef('often_forgotten_bosun_chair', 'Stav bosunového kresla', 'Bosun\'s chair condition',
        ...
        labelCs: 'Stav bosmanského křesla', labelPl: 'Stan krzesełka bosmańskiego', labelEl: 'Κατάσταση καθίσματος ναύτη', labelHr: 'Penjalica za jarbol', labelSl: 'Sedež za vzpon na jambor'),
    HandoverItemDef('often_forgotten_saltwater_pump_impeller', 'Gumový impulzný kolektor pre čerpadlo slanej vody',
        ...
        labelCs: 'Impeler čerpadla mořské vody', labelPl: 'Wirnik pompy wody morskiej', labelEl: 'Φτερωτή αντλίας θαλασσινού νερού', labelHr: 'Impeler pumpe morske vode', labelSl: 'Impeler črpalke morske vode'),
    HandoverItemDef('often_forgotten_halyard_condition', 'Stav zdvíhacieho lana', 'Hoisting line condition',
        ...
        labelCs: 'Stav zvedacího lana', labelPl: 'Stan liny podnoszącej', labelEl: 'Κατάσταση ανυψωτικού σχοινιού', labelHr: 'Stanje konopa za dizanje', labelSl: 'Stanje vrvi za dviganje'),
    HandoverItemDef('often_forgotten_dinghy_condition', 'Stav člna (dinghy)', 'Dinghy condition',
        ...
        labelCs: 'Stav člunu (dinghy)', labelPl: 'Stan pontonu (dinghy)', labelEl: 'Κατάσταση βοηθητικής λέμβου (dinghy)', labelHr: 'Stanje gumenjaka', labelSl: 'Stanje gumenjaka'),
  ], labelCs: 'Často zapomenuté', labelPl: 'Często zapominane', labelEl: 'Συχνά ξεχνιούνται', labelHr: 'Često zaboravljeno', labelSl: 'Pogosto pozabljeno'),
  HandoverCategoryDef('misc', 'Rôzne', 'Miscellaneous',
    ...
    HandoverItemDef('misc_spare_rudder', 'Náhradné kormidlo', 'Spare rudder',
        ...
        labelCs: 'Náhradní kormidlo', labelPl: 'Ster zapasowy', labelEl: 'Εφεδρικό πηδάλιο', labelHr: 'Rezervno kormilo', labelSl: 'Rezervno krmilo'),
    HandoverItemDef('misc_bucket_brush_sponge', 'Vedro, kefa, špongia', 'Bucket, brush, sponge',
        ...
        labelCs: 'Kbelík, kartáč, houba', labelPl: 'Wiadro, szczotka, gąbka', labelEl: 'Κουβάς, βούρτσα, σφουγγάρι', labelHr: 'Kanta, četka, spužva', labelSl: 'Vedro, krtača, goba'),
    HandoverItemDef('misc_oar_locks', 'Háky na veslá člna', 'Dinghy oar locks',
        ...
        labelCs: 'Vidlice na vesla člunu', labelPl: 'Dulki wioseł pontonu', labelEl: 'Σκαρμοί κουπιών λέμβου', labelHr: 'Vilice za vesla gumenjaka', labelSl: 'Vilice za vesla gumenjaka'),
    HandoverItemDef('misc_lifebuoy', 'Záchranný kruh alebo podkova', 'Lifebuoy or horseshoe buoy',
        ...
        labelCs: 'Záchranný kruh nebo podkova', labelPl: 'Koło ratunkowe lub podkowa', labelEl: 'Σωσίβιο κυκλικό ή πέταλο', labelHr: 'Kolut za spašavanje ili potkova', labelSl: 'Rešilni obroč ali podkev'),
    HandoverItemDef('misc_anchor_lines', 'Kotvové laná', 'Anchor lines',
        'Ankerleinen', 'Cabos del ancla', 'Якірні троси',
        labelCs: 'Kotevní lana', labelPl: 'Liny kotwiczne', labelEl: 'Σχοινιά άγκυρας', labelHr: 'Sidreni konopi', labelSl: 'Sidrne vrvi'),
    HandoverItemDef('misc_bilge_pump', 'Ručná bilge pumpa', 'Manual bilge pump',
        ...
        labelCs: 'Ruční bilžní pumpa', labelPl: 'Ręczna pompa zęzowa', labelEl: 'Χειροκίνητη αντλία σεντίνας', labelHr: 'Ručna kaljužna pumpa', labelSl: 'Ročna kalužna črpalka'),
    HandoverItemDef('misc_extension_cable', 'Predlžovací elektrický kábel', 'Electrical extension cable',
        ...
        labelCs: 'Prodlužovací elektrický kabel', labelPl: 'Przedłużacz elektryczny', labelEl: 'Ηλεκτρική μπαλαντέζα', labelHr: 'Produžni električni kabel', labelSl: 'Električni podaljšek'),
    HandoverItemDef('misc_lifebuoy_light', 'Záchranná bója so svetlom', 'Lifebuoy with light',
        ...
        labelCs: 'Záchranná bóje se světlem', labelPl: 'Boja ratunkowa ze światłem', labelEl: 'Σωσίβια σημαδούρα με φως', labelHr: 'Kolut za spašavanje sa svjetlom', labelSl: 'Rešilni obroč z lučjo'),
    HandoverItemDef('misc_spare_anchor', 'Záložná kotva', 'Spare anchor',
        'Ersatzanker', 'Ancla de respeto', 'Запасний якір',
        labelCs: 'Záložní kotva', labelPl: 'Kotwica zapasowa', labelEl: 'Εφεδρική άγκυρα', labelHr: 'Rezervno sidro', labelSl: 'Rezervno sidro'),
    HandoverItemDef('misc_dinghy_oars_pump', 'Veslá a pumpa pre čln', 'Dinghy oars and pump',
        ...
        labelCs: 'Vesla a pumpa pro člun', labelPl: 'Wiosła i pompka do pontonu', labelEl: 'Κουπιά και αντλία για τη λέμβο', labelHr: 'Vesla i pumpa za gumenjak', labelSl: 'Vesla in tlačilka za gumenjak'),
    HandoverItemDef('misc_shroud_cutter', 'Shroud cutter (nôž na lanká)', 'Shroud cutter',
        'Wantenschneider', 'Cortaobenques', 'Різак для вант',
        labelCs: 'Shroud cutter (nůž na lanka)', labelPl: 'Obcinak want (nóż do olinowania)', labelEl: 'Κόφτης ξαρτιών', labelHr: 'Rezač sartija', labelSl: 'Rezalnik jamborskih vrvi'),
  ], labelCs: 'Různé', labelPl: 'Różne', labelEl: 'Διάφορα', labelHr: 'Razno', labelSl: 'Razno'),
];
...
const List<HandoverCategoryDef> checkOutCategories = [
  HandoverCategoryDef('return_yacht', 'Vrátenie jachty', 'Returning the yacht',
    ...
    HandoverItemDef('return_yacht_refuel', 'Dotankovať nádrž', 'Refuel the tank',
        ...
        labelCs: 'Zatankovat nádrž', labelPl: 'Zatankować zbiornik', labelEl: 'Ανεφοδιασμός δεξαμενής', labelHr: 'Napuniti tank gorivom', labelSl: 'Napolniti rezervoar z gorivom'),
    HandoverItemDef('return_yacht_handover_confirmation', 'Získať potvrdenie o odovzdaní jachty',
        ...
        labelCs: 'Získat potvrzení o předání jachty', labelPl: 'Uzyskać potwierdzenie przekazania jachtu', labelEl: 'Λήψη επιβεβαίωσης παράδοσης σκάφους', labelHr: 'Ishoditi potvrdu o primopredaji jahte', labelSl: 'Pridobiti potrdilo o primopredaji jahte'),
    HandoverItemDef('return_yacht_arrival_time', 'Prísť do mariny v dohodnutom čase',
        ...
        labelCs: 'Přijet do maríny v dohodnutém čase', labelPl: 'Przybyć do mariny o umówionej porze', labelEl: 'Άφιξη στη μαρίνα στη συμφωνημένη ώρα', labelHr: 'Doći u marinu u dogovoreno vrijeme', labelSl: 'Priti v marino ob dogovorjenem času'),
    HandoverItemDef('return_yacht_deposit', 'Vrátiť zálohu', 'Return the deposit',
        ...
        labelCs: 'Vrátit zálohu', labelPl: 'Zwrot kaucji', labelEl: 'Επιστροφή εγγύησης', labelHr: 'Povrat depozita', labelSl: 'Vračilo varščine'),
  ...
  HandoverCategoryDef('cleanliness', 'Čistota a poriadok', 'Cleanliness and order',
    ...
    HandoverItemDef('cleanliness_exterior', 'Loď vyčistená – exteriér', 'Boat cleaned – exterior',
        ...
        labelCs: 'Loď vyčištěná – exteriér', labelPl: 'Jacht wyczyszczony – na zewnątrz', labelEl: 'Σκάφος καθαρισμένο – εξωτερικά', labelHr: 'Brod očišćen – vanjski dio', labelSl: 'Plovilo očiščeno – zunanjost'),
    HandoverItemDef('cleanliness_interior', 'Loď vyčistená – interiér', 'Boat cleaned – interior',
        ...
        labelCs: 'Loď vyčištěná – interiér', labelPl: 'Jacht wyczyszczony – wewnątrz', labelEl: 'Σκάφος καθαρισμένο – εσωτερικά', labelHr: 'Brod očišćen – unutrašnjost', labelSl: 'Plovilo očiščeno – notranjost'),
    HandoverItemDef('cleanliness_cabins', 'Kajuty upratané', 'Cabins tidied',
        'Kajüten aufgeräumt', 'Camarotes ordenados', 'Каюти прибрані',
        labelCs: 'Kajuty uklizené', labelPl: 'Kabiny posprzątane', labelEl: 'Καμπίνες τακτοποιημένες', labelHr: 'Kabine pospremljene', labelSl: 'Kabine pospravljene'),
    HandoverItemDef('cleanliness_galley', 'Kuchyňa vyčistená', 'Galley cleaned',
        'Pantry gereinigt', 'Cocina limpia', 'Камбуз прибраний',
        labelCs: 'Kuchyně vyčištěná', labelPl: 'Kambuz wyczyszczony', labelEl: 'Μαγειρείο καθαρισμένο', labelHr: 'Kuhinja očišćena', labelSl: 'Kuhinja očiščena'),
    HandoverItemDef('cleanliness_toilet', 'WC vyčistené', 'Toilet cleaned',
        'WC gereinigt', 'Inodoro limpio', 'Гальюн прибраний',
        labelCs: 'WC vyčištěné', labelPl: 'WC wyczyszczone', labelEl: 'Τουαλέτα καθαρισμένη', labelHr: 'Toalet očišćen', labelSl: 'Stranišče očiščeno'),
    HandoverItemDef('cleanliness_trash', 'Odpadky odstránené', 'Trash removed',
        'Müll entsorgt', 'Basura retirada', 'Сміття винесене',
        labelCs: 'Odpadky odstraněny', labelPl: 'Śmieci usunięte', labelEl: 'Σκουπίδια απομακρύνθηκαν', labelHr: 'Smeće uklonjeno', labelSl: 'Smeti odstranjene'),
  ], labelCs: 'Čistota a pořádek', labelPl: 'Czystość i porządek', labelEl: 'Καθαριότητα και τάξη', labelHr: 'Čistoća i red', labelSl: 'Čistoča in red'),
  HandoverCategoryDef('technical', 'Technický stav', 'Technical condition',
    ...
    HandoverItemDef('technical_fuel', 'Palivo doplnené', 'Fuel topped up',
        ...
        labelCs: 'Palivo doplněno', labelPl: 'Paliwo uzupełnione', labelEl: 'Καύσιμο συμπληρώθηκε', labelHr: 'Gorivo nadopunjeno', labelSl: 'Gorivo dopolnjeno'),
    HandoverItemDef('technical_water', 'Voda doplnená', 'Water topped up',
        'Wasser aufgefüllt', 'Agua repostada', 'Вода долита',
        labelCs: 'Voda doplněna', labelPl: 'Woda uzupełniona', labelEl: 'Νερό συμπληρώθηκε', labelHr: 'Voda nadopunjena', labelSl: 'Voda dopolnjena'),
    HandoverItemDef('technical_damage', 'Poškodenia zdokumentované a hlásené', 'Damage documented and reported',
        ...
        labelCs: 'Poškození zdokumentována a nahlášena', labelPl: 'Uszkodzenia udokumentowane i zgłoszone', labelEl: 'Ζημιές καταγράφηκαν και αναφέρθηκαν', labelHr: 'Oštećenja dokumentirana i prijavljena', labelSl: 'Poškodbe dokumentirane in prijavljene'),
    HandoverItemDef('technical_sails', 'Plachty zložené a zviazané', 'Sails furled and secured',
        ...
        labelCs: 'Plachty složené a svázané', labelPl: 'Żagle zwinięte i zabezpieczone', labelEl: 'Πανιά μαζεμένα και ασφαλισμένα', labelHr: 'Jedra namotana i osigurana', labelSl: 'Jadra zvita in zavarovana'),
    HandoverItemDef('technical_lines', 'Laná upratané', 'Lines tidied',
        'Leinen aufgeräumt', 'Cabos ordenados', 'Троси прибрані',
        labelCs: 'Lana uklizena', labelPl: 'Liny uporządkowane', labelEl: 'Σχοινιά τακτοποιημένα', labelHr: 'Konopi pospremljeni', labelSl: 'Vrvi pospravljene'),
  ], labelCs: 'Technický stav', labelPl: 'Stan techniczny', labelEl: 'Τεχνική κατάσταση', labelHr: 'Tehničko stanje', labelSl: 'Tehnično stanje'),
  HandoverCategoryDef('handover', 'Odovzdanie', 'Handover',
    ...
    HandoverItemDef('handover_keys', 'Kľúče odovzdané', 'Keys handed over',
        ...
        labelCs: 'Klíče předány', labelPl: 'Klucze przekazane', labelEl: 'Κλειδιά παραδόθηκαν', labelHr: 'Ključevi predani', labelSl: 'Ključi predani'),
    HandoverItemDef('handover_documents', 'Doklady odovzdané', 'Documents handed over',
        ...
        labelCs: 'Doklady předány', labelPl: 'Dokumenty przekazane', labelEl: 'Έγγραφα παραδόθηκαν', labelHr: 'Dokumenti predani', labelSl: 'Dokumenti predani'),
    HandoverItemDef('handover_life_jackets', 'Záchranné vesty vrátené', 'Life jackets returned',
        ...
        labelCs: 'Záchranné vesty vráceny', labelPl: 'Kamizelki ratunkowe zwrócone', labelEl: 'Σωσίβια επιστράφηκαν', labelHr: 'Prsluci za spašavanje vraćeni', labelSl: 'Rešilni jopiči vrnjeni'),
  ], labelCs: 'Předání', labelPl: 'Przekazanie', labelEl: 'Παράδοση', labelHr: 'Primopredaja', labelSl: 'Primopredaja'),
];
