...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get windFieldLayer => 'Πεδίο ανέμου';

  @override
  String get windFieldNone => 'Άνεμος: ασθενής σε αυτή την περιοχή';

  @override
  String get mapWindAtBoat => 'Άνεμος και ριπές στη θέση του σκάφους (μοντέλο)';

  @override
  String get weatherSourceLimited =>
      'Η πηγή καιρού εξαντλήθηκε για σήμερα (ημερήσιο όριο)';

  @override
  String get weatherLayerUnavailable => 'Το στρώμα καιρού δεν φορτώθηκε';
  ...
  @override
  String get cloudLayer => 'Νέφωση';

  @override
  String get cloudNone => 'Νέφωση: αίθριος σε αυτή την περιοχή';

  @override
  String get precipitationNone => 'Βροχόπτωση: καμία σε αυτή την περιοχή';
  ...
  @override
  String get precipitationLayer => 'Βροχόπτωση (πρόγνωση)';
