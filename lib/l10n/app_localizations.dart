...
abstract class AppLocalizations {
  ...
  /// No description provided for @logEventSailSet.
  ///
  /// In sk, this message translates to:
  /// **'Plachty: {sails}'**
  String logEventSailSet(String sails);

  /// No description provided for @mapSails.
  ///
  /// In sk, this message translates to:
  /// **'Plachty'**
  String get mapSails;
