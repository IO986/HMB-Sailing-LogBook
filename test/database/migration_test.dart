...
void main() {
  ...
  test('migrate v7 to current (v27)', () async {
  ...
  test('migrate v8 to current (v27)', () async {
  ...
  test('migrate v9 to current (v27)', () async {
  ...
  test('migrate v10 to current (v27): handoverProtocols.extraNotes', () async {
  ...
  test('migrate v11 to current (v27): logbook record fields', () async {
  ...
  test('migrate v12 to current (v27): Charters.source', () async {
  ...
  test('migrate v13 to current (v27): extended charter form fields', () async {
  ...
  test('migrate v14 to current (v27): trackPoints location metadata', () async {
  ...
  test('migrate v15 to current (v27): logbookEntries location metadata', () async {
  ...
  test('migrate v16 to current (v27): outbox table', () async {
  ...
  test('migrate v17 to current (v27): tideSnapshots table', () async {
  ...
  test('migrate v18 to current (v27): tide location label + manual flag',
      () async {
  ...
  test('migrate v19 to current (v27): dutyPeriods table', () async {
  ...
  test('migrate v20 to current (v27): logbookEntries.eventType', () async {
  ...
  test('migrate v21 to current (v27): logbookEntries.sailMode', () async {
  ...
  test('migrate v22 to current (v27): crewAssessments table', () async {
  ...
  test('migrate v23 to current (v27): charters.tidalWaters', () async {
  ...
  test('migrate v24 to current (v27): bearings table', () async {
  ...
  test('migrate v25 to current (v27): bearings.hiddenFromMap', () async {
