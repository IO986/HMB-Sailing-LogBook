...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get guideQuickStartBody =>
      '1. Відкрий Журнал → натисни + → обери \"Новий рейс\"\n2. Введи назву судна та орієнтовну кількість днів\n3. Відстеження починається автоматично – поклади телефон у кишеню\n4. Вноси записи протягом дня: час, позиція, нотатка\n5. Наприкінці рейсу: Налаштування → Експорт PDF';
  ...
  String get guideLogbookBody =>
      'Журнал – головна вкладка для управління рейсами.\n\n• Натисни + (FAB) → \"Новий рейс\" для створення чартеру\n• Відстеження починається з цього діалогу – позиція записується автоматично\n• Кожен день рейсу відображається окремо\n• Записи можна вносити вручну протягом дня\n• Журнал можна експортувати в PDF через меню дня';
