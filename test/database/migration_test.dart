...
void main() {
  ...
  test('onCreate builds a schema matching the current (v17) snapshot', () async {
  ...
  test('migrate v7 to current (v17)', () async {
  ...
  test('migrate v8 to current (v17)', () async {
  ...
  test('migrate v9 to current (v17)', () async {
  ...
  test('migrate v10 to current (v17): handoverProtocols.extraNotes', () async {
  ...
  test('migrate v11 to current (v17): logbook record fields', () async {
  ...
  test('migrate v12 to current (v17): Charters.source', () async {
  ...
  test('migrate v13 to current (v17): extended charter form fields', () async {
  ...
  test('migrate v14 to current (v17): trackPoints location metadata', () async {
  ...
  test('migrate v15 to current (v17): logbookEntries location metadata', () async {
  ...
  test('migrate v16 to current (v17): outbox table', () async {
