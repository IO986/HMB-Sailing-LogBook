...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get mapDepths => 'Глибини';

  @override
  String mapDepthHere(String depth) {
    return 'Глибина тут: $depth';
  }

  @override
  String get mapDepthNoData => 'Немає даних про глибину для цієї точки';
  ...
  String get weatherOfflineNoAge =>
      'Немає зв’язку — остання збережена прогноза';

  @override
  String weatherOfflineSince(String when) {
    return 'Немає зв’язку — прогноз від $when';
  }

  @override
  String weatherStaleSince(String when) {
    return 'Прогноз старий — завантажено $when';
  }

  @override
  String get warningNoDetail => 'Не вдалося завантажити подробиці.';

  @override
  String get warningSourceMeteoalarm => 'Джерело: MeteoAlarm';

  @override
  String warningLanguageNote(String lang) {
    return 'Текст мовою: $lang';
  }
  ...
  @override
  String get playbackTitle => 'Відтворити плавання';

  @override
  String get playbackSpeed => 'Швидкість';

  @override
  String get playbackNoTrack => 'Для цього дня маршрут не записано';
  ...
  String get mapOfflineTilesHint =>
      'Немає інтернету — карта не завантажить нові плитки. Завантаж район, поки є сигнал.';
  ...
  @override
  String get portFromLabel => 'Порт відходу';

  @override
  String get portToLabel => 'Порт приходу';

  @override
  String get routeAutoFillHint =>
      'Заповнюється автоматично з GPS за наявності мережі. Якщо лишилося порожнім, впиши тут.';
  ...
  @override
  String get deleteCharterTitle => 'Видалити плавання?';
  ...
  @override
  String get createFirstCharter => 'Створи своє перше плавання';
  ...
  @override
  String get exportsTitle => 'Експорти';

  @override
  String get exportMapLayer => 'Підкладка карти у фрагменті';

  @override
  String get exportMapSatellite => 'Супутник';

  @override
  String get exportMapPlain => 'Карта';

  @override
  String get exportsThisVoyage => 'Це плавання';

  @override
  String get exportsAcrossVoyages => 'Через плавання';

  @override
  String get exportsAutomatic => 'Автоматично';

  @override
  String get exportsWholeVoyage => 'Усе плавання';

  @override
  String get exportsWholeVoyageDesc =>
      'Усі дні з картами, екіпажем і підписами';

  @override
  String get exportsDay => 'День';

  @override
  String get exportsDayDesc => 'Один день плавання разом із треком';

  @override
  String get exportsHandoverDesc => 'Акт приймання та повернення судна';

  @override
  String get exportsCrewCertsDesc => 'Милі й оцінка окремо для кожного члена';

  @override
  String get exportsMilesCertDesc => 'Пройдені милі з вибраних плавань';

  @override
  String get exportsBearingsDesc => 'Пеленги, зняті поза плаванням';

  @override
  String get exportsCloudTitle => 'Експорт у Google Диск';

  @override
  String get exportsCloudOn => 'Увімкнено — завершений день іде сам';

  @override
  String get exportsCloudOff => 'Вимкнено — усе лишається в телефоні';
  ...
  @override
  String get exportsPickVoyage => 'Вибери плавання';

  @override
  String get exportsNoVoyages => 'Ще жодного плавання';

  @override
  String get exportsNoDays => 'У цьому плаванні немає записаного дня';

  @override
  String get exportsNoBearings => 'Немає пеленгів поза плаванням';

  @override
  String get exportsNotFilledIn => 'Не заповнено';
  ...
  @override
  String get milesExportPickCrew => 'Вибрати з екіпажу';
  ...
  @override
  String get pdfNameLabel => 'Ім\'я';

  @override
  String get pdfLicenceLabel => 'Ліцензія';

  @override
  String get pdfIssuedValidLabel => 'Видано / дійсна';

  @override
  String get pdfOtherCertsLabel => 'Інші серт.';

  @override
  String get pdfContinued => 'продовження';

  @override
  String get pdfExportedAt => 'Експортовано';

  @override
  String get pdfSignedAt => 'Підписано';

  @override
  String get pdfSignatureLabel => 'Підпис';

  @override
  String get pdfDatePlaceLabel => 'Дата / місце';

  @override
  String get pdfManualEntryNote => '* ручний запис (введено вручну)';

  @override
  String get pdfStatTotalDistance => 'Загальна відстань';

  @override
  String get pdfStatLogEntries => 'Записи журналу';

  @override
  String get pdfStatMaxBeaufort => 'Макс. Beaufort';

  @override
  String get pdfStatDaysAtSea => 'Дні в морі';

  @override
  String get pdfStatVoyages => 'Кількість плавань';

  @override
  String get pdfStatNightHours => 'Нічні години';

  @override
  String get pdfFuelShort => 'П';

  @override
  String get pdfWaterShort => 'В';
  ...
  @override
  String get autoEntryNote => 'Автоматичний запис';

  @override
  String get logEventSailChange => 'Зміна галсу';

  @override
  String get logEventCourseChange => 'Зміна курсу';

  @override
  String get pdfNightShort => 'ніч';

  @override
  String nightSailingHours(String hours) {
    return 'Нічне плавання $hours год';
  }

  @override
  String logEventSailChangeTo(String direction) {
    return 'Зміна галсу: $direction';
  }
  ...
  String logEventAutopilotOn(String mode) {
    return 'Автопілот УВІМК - $mode';
  }

  @override
  String get logEventAutopilotOff => 'Автопілот ВИМК';

  @override
  String get logEventEngineStart => 'Двигун запущено';

  @override
  String get logEventEngineStop => 'Двигун зупинено';

  @override
  String get updateDownloaded => 'Оновлення завантажено';

  @override
  String get updateRestart => 'Перезапустити';
  ...
  @override
  String get autopilotModeWind => 'Вітер';

  @override
  String get autopilotModeTrack => 'Маршрут';

  @override
  String get autopilotModeHeading => 'Курс';

  @override
  String get autopilotModeRudder => 'Кермо';

  @override
  String get autopilotModeStandby => 'Очікування';
  ...
  @override
  String get charterCheckCard => 'Плавання';
  ...
  String get errorBadResponse =>
      'Відповідь сервера не вдалося обробити. Спробуй пізніше.';
  ...
  @override
  String get rateAppDesc => 'Відкриває сторінку додатка в Google Play';
  ...
  @override
  String get sailDirection => 'Курс відносно вітру';

  @override
  String get pointOfSailCloseHauled => 'Крутий бейдевінд';

  @override
  String get pointOfSailCloseReach => 'Бейдевінд';

  @override
  String get pointOfSailBeamReach => 'Галфвінд';

  @override
  String get pointOfSailBroadReach => 'Бакштаг';

  @override
  String get pointOfSailRunning => 'Фордевінд';

  @override
  String get tackPort => 'Лівий галс';

  @override
  String get tackStarboard => 'Правий галс';
  ...
  @override
  String get mapStationWindLayer => 'Станції – виміряно';

  @override
  String get windGust => 'Порив';

  @override
  String get radarTitle => 'Радар опадів';

  @override
  String get radarRefresh => 'Оновити зображення';

  @override
  String get radarUnavailable =>
      'Не вдалося завантажити зображення радара. Спробуй ще раз, коли буде зв’язок.';

  @override
  String get radarSourceDhmz => 'Джерело: DHMZ – meteo.hr';

  @override
  String get weatherSourceInstruments => 'Виміряно судновими приладами';

  @override
  String get pdfWeatherSourceInstruments => 'Прилади';
  ...
  @override
  String get pdfWeatherSourceStationUnknown => 'Метеостанція';

  @override
  String get pdfWeatherSourceModel => 'Модель';
  ...
  @override
  String get quickNoteHint => 'Що щойно сталося';

  @override
  String get pickVoyageAction => 'Вибрати плавання';
  ...
  @override
  String get exportCharterTitle => 'Експорт плавання';
  ...
  @override
  String get exportCharterBtn => 'Експортувати плавання';
  ...
  @override
  String get deleteWaypointTitle => 'Видалити путьову точку?';

  @override
  String deleteWaypointNavActive(String name) {
    return 'Навігація до $name активна. Видалення точки її вимкне.';
  }
  ...
  @override
  String get editCharter => 'Редагувати плавання';
  ...
  String get guideMapBody =>
      'Вкладка Карта показує твоє поточне місцезнаходження та маршрут рейсу.\n\n• Синя точка = поточна позиція\n• Синя лінія = маршрут, що зараз записується\n• Значок маршруту – вибери будь-який рейс або день і подивись його трек на карті (помаранчевим), без PDF-експорту Знизу з’являється відтворення: повзунком проходиш плавання в часі й бачиш положення, швидкість, курс, вітер і тиск у будь-яку мить. Риски на повзунку — це події: початок і кінець плавання, якір, дрейф, MOB.\n• Перемикання між супутниковим і карт-видом\n• Морські знаки – перемикач навігаційних знаків (затонулі судна, мілини, буї)\n• Глибини – ізобати з EMODnet із глибиною в метрах. Модель дна за промірами, це НЕ морська карта: для планування переходу так, для рішення «чи пройду тут» ні. Типово вимкнено; переглянуті плитки зберігаються, як і решта. Коли шар увімкнено, торкніться карти, щоб дізнатися глибину в цій точці (потрібен сигнал).\n• Порти – клікабельний шар якірних стоянок, марин і портів (дані OpenStreetMap): торкнись значка, щоб побачити назву, канал VHF, телефон, сайт (дотик одразу дзвонить або відкриває сайт), глибину чи місткість, якщо відомі; місце можна одразу зберегти як путьову точку; шар містить і паливні станції для човнів (помаранчева колонка)\n• Лінійка (фіолетовий значок) – торкайся точок на карті: сума NM, курс останнього відрізка та ETA при поточній швидкості; точки прилипають до путьових точок\n• Офлайн-карта (значок завантаження) — завантажує видиму область для роботи без зв’язку, від поточного масштабу на три рівні глибше. Завжди морські знаки; з увімкненим супутником — також знімки та їхні назви місцевостей. До того ж кожна переглянута плитка зберігається автоматично.\n• У нічному режимі карта автоматично перемикається на темні плитки\n• Значок якоря = місце стоянки (лише при активній якірній сигналізації)\n• Значок імпорту – завантажує треки і точки маршруту з файлу .gpx (див. \"Імпорт GPX\")\n• Фіксація на північ – утримуйте розу компаса (вгорі ліворуч); карта перестає обертатися й залишається орієнтованою на північ. Торкніться, щоб повернути на північ.\n• Вибрані шари (супутник, морські знаки, глибини, порти), стеження за GPS і фіксація на північ запам’ятовуються між запусками\n• Довге натискання на карту = додати путьову точку (ціль навігації); торкнись існуючої точки, щоб перейменувати або видалити її\n• Карта живе з мережі: без інтернету нові плитки не завантажуються і видно лише район із кешу. Перед виходом завантаж район кнопкою «Завантажити область офлайн» на карті. Коли телефон офлайн, карта нагадає про це помаранчевою смугою вгорі.\n• Під час плавання на карті є дві додаткові кнопки. Якір запускає якірну вахту на поточній позиції з радіусом, який ти використав востаннє — одне торкання, а наступне перед зупинкою перепитає. Червону MOB треба притримати; торкання лише нагадає про це. Поки вахта працює, карта малює відхід: лінію, яку судно описало навколо якоря на ланцюгу.\n• Торкання якоря тепер перед запуском питає про радіус: пропонує використаний востаннє, але скільки ланцюга судно витягне, залежить від глибини, ґрунту й вітру — в іншій бухті це інше число.';
  ...
  String get guideInstrBody =>
      'Вкладка Прилади показує навігаційні дані в реальному часі.\n\n• SOG – швидкість над ґрунтом (вузли)\n• TWS – істинна швидкість вітру\n• TWA – кут вітру відносно судна (зелений = правий борт, червоний = лівий борт)\n• DEPTH – глибина води (червоний = менше 5 м)\n• VMG WP – швидкість до обраної путьової точки; після вибору побачиш відстань/пеленг і стрілку прямо на компасній розі. Навігацію вимкнеш вибором \"Без цілі\" в тій самій плитці — її вимикає й видалення путьової точки на мапі\n• АВТОПІЛОТ – показує УВІМК/ВИМК і режим керування, коли прилади це передають (HTC/HTD, APB або SeaTalk). Кожне перемикання автоматично записується в журнал, як у бортовому журналі літака.\n\nДжерело даних: GPS телефону або Raymarine (WiFi-шлюз TCP чи UDP).\nНалаштування підключення (включно з вибором TCP/UDP): Налаштування → Прилади.\n\nЯк підключається судно: додаток читає дані NMEA через WiFi (TCP чи UDP). Власного WiFi-хотспоту Raymarine MFD зазвичай недостатньо — він призначений для додатків Raymarine і зазвичай не віддає сирі NMEA стороннім. Потрібен NMEA-у-WiFi шлюз (напр. Digital Yacht, Yacht Devices, Actisense, Quark-elec), підключений до шини судна, який або створює власний хотспот, або транслює NMEA у WiFi. Підключися до WiFi цього шлюзу і введи його IP та порт у Налаштуваннях (або спробуй Автопошук).\n\nB&G Zeus та подібні плотери Navico: підключи телефон до WiFi плотера і в Налаштуваннях обери TCP. Адреса плотера в мережі WiFi НЕ працює — сервер NMEA працює на його інтерфейсі Ethernet. Цю адресу знайдеш у самому плотері: Settings → Network → Diagnostics, пункт IP address (зазвичай у вигляді 169.254.x.x). Введи її разом з портом 10110. Перевірено на Zeus III з програмою NOS v25.2. Порт 2053 приймає зʼєднання, але даних не надсилає — це служба GoFree з власним протоколом, а не NMEA. Увімкни автоматичне підключення під час запуску. Якщо колись перестане працювати, адреса могла змінитися — прочитай її знову в Diagnostics.\n• Картушка компаса має в центрі кола курс носа, а під ним дрібним шрифтом COG. Різниця між ними — знос від течії та вітру; з одного числа її не видно.';
  ...
  String get guideLogbookBody =>
      'Журнал — головна вкладка для керування рейсами.\n\n• Велика кнопка \"Почати рейс\" вгорі запускає трекінг – запитує лише частоту автоматичних записів (можна змінити при кожному новому старті), жодної форми заповнювати заздалегідь не потрібно\n• Якщо вже є відкритий рейс, застосунок запитає, чи продовжити його, чи почати новий запис\n• Відсутні дані (чек-ін, інструктаж з безпеки, картка судна/екіпажу) нагадуються кольоровими чипами прямо на картці рейсу – торкнись чипа, щоб заповнити\n• Кожен день рейсу відображається окремо\n• Записи можна вносити вручну протягом дня, включно з мотогодинами, паливом і водою в розділі \"Двигун і баки\"\n• Під час відстеження внизу зліва з\'являється кнопка камери – сфотографуй цікаву точку і збережи як швидкий запис із позицією та часом\n• Журнал можна експортувати в PDF через меню дня\n• Значок рукостискання в деталях рейсу відкриває протокол передачі (check-in/check-out)\n• Детальна форма рейсу (значок судна в деталях) фіксує судно та його параметри, район плавання, екіпаж із посвідченнями шкіпера та фото судна (макс. 3, переносяться в PDF)\n• Незаповнені картки (інструктаж з безпеки, чек-ін/аут, картка судна) блимають червоним у верхній панелі деталей рейсу, поки їх не завершиш\n• Якщо застосунок закриється під час плавання без зупинки трасування (система його завершила, випадковий свайп), наступний запуск запропонує продовжити те саме плавання — разом із відстанню, пройденою, поки застосунок не працював\n• Під час першого запуску плавання застосунок нагадає про налаштування батареї — без них система (особливо Honor/Huawei) може вимкнути трасування у фоні\n• Іконка маршруту в заголовку плавання (поруч із брифінгом, протоколом і карткою судна) показує весь трек на карті\n• Після плавання можна експортувати підтвердження пройдених миль для кожного члена екіпажу — дні в морі, денні та нічні милі, район плавання, оцінка шкіпера і QR для перевірки\n• Спосіб руху (двигун/вітрила) переходить і в автоматичні записи — задаєш раз, наступні продовжують у ньому\n• Підтвердження двомовне (твоя мова + англійська), містить розміри та реєстрацію судна, тип вод (припливні/неприпливні) і рядок для номера паспорта чи ID; можна поділитися або зберегти у телефон\n• Курс відносно вітру – силует судна з паперового журналу: торкніться курсу з того борту, звідки дме вітер (лівий галс червоний, правий зелений). Фордевінд унизу, там борт не розрізняється. Повторний дотик скасовує вибір – вгаданий запис гірший за порожню клітинку. У PDF він стоїть поруч із рушієм.\n• Під час запису другa швидка кнопка (значок вітрильника, ліворуч унизу) фіксує поворот оверштаг або фордевінд: вибери новий курс на силуеті, і запис збережеться з позицією та часом. Наступні автоматичні записи тримають цей курс, доки не зміниш його знову.\n• Глибина з ехолота зберігається в автоматичних записах і підставляється в ручний запис (потрібні під’єднані прилади).\n• Мотогодини рахуються з обертів із приладів, а запуск і зупинка двигуна записуються в журнал самі.\n• Швидка кнопка з вітрильником (внизу ліворуч під час плавання) тепер записує й рушій — Мотор / Грот / Генуя / Риф. Наступні автоматичні записи переймають його, доки не зміниш, тож стовпець Рушій у PDF більше не лишається порожнім.\n• Застосунок сам записує зміну курсу: коли напрямок відхиляється на 30° і більше та тримається щонайменше хвилину. Виляння на хвилі чи стрибок GPS цього не запустять.\n• Автоматичні записи несуть і стан неба — заповнюється з моделі для часу й позиції запису, як вітер і тиск.\n• Нічне плавання рахується саме, за справжнім заходом і сходом сонця для позиції судна. Запис після смеркання має місяць, а день і все плавання мають суму нічних годин — у щоденнику й у PDF.\n• Нове плавання створюєш кнопкою **Нове плавання** у Щоденнику — заповнюєш судно, район і екіпаж ще до виходу, а запис потім до нього прив’яжеться. Натиснути Старт одразу теж можна.\n• Маршрут дня (звідки → куди) заповнюється з GPS, але лише за робочого інтернету — у Wi-Fi суднових приладів телефон його не має, тож порти можуть лишитися порожніми. Застосунок заповнить їх пізніше сам, а вписати їх можна будь-коли, торкнувшись маршруту в картці дня. Де порту немає, PDF друкує координати замість знака питання.\n• Рушій на початку — Мотор: із порту виходять під двигуном, а порожня колонка Рушій не була правдивішою за мотор, лише менш читабельною. Перша зміна (швидка кнопка або ручний запис) її перезаписує, а наступні автоматичні записи її продовжують.\n• Судно можна зберегти до списку суден — кнопкою «Вибрати з моїх суден» у картці плавання наступне плавання заповниш одним дотиком, разом із моделлю, позивним, MMSI, розмірами й баками. Зберігається разом із плаванням; власне судно познач галочкою і буде першим. Плавання тримає власну копію даних, тож пізніша зміна списку не змінить уже підписаний документ.\n• Біля швидкої зміни вітрил є й кнопка Швидка нотатка — пишеш речення, і запис зберігається з усім, що застосунок знає (позиція, час, швидкість, курс, вітер, тиск, температури, глибина, рушій). Те саме, що швидке фото, лише без фото.\n• Коли відкрито кілька плавань одразу (на навчанні по одному на курсанта), запит при старті має третю можливість — Вибрати плавання — і продовжує вибране, а не автоматично найновіше.';
  ...
  String get guideWeatherBody =>
      'Вкладка Погода показує прогноз за поточним місцезнаходженням.\n\n• Оновлюється автоматично при зміні позиції\n• Гори розташовані ОФІЦІЙНІ ПОПЕРЕДЖЕННЯ (MeteoAlarm), якщо для твоєї країни вони діють. Їх видає не модель, а національна метеослужба — у Хорватії DHMZ, у Британії Met Office, у Швеції SMHI. Розгорнувши, побачиш опис і пораду; якщо тексту твоєю мовою немає, застосунок скаже, якою мовою ти його читаєш.\n• Прогноз береться з НАЦІОНАЛЬНОЇ МОДЕЛІ для місця, де ти є — Адріатика та Італія ARPAE ICON-2I, Британія UKMO, Скандинавія MET Norway, Центральна Європа ICON-D2, в інших місцях ECMWF. Назва моделі видна під поточною погодою.\n• Картка Станції – виміряно показує, що справді хтось виміряв, із відстанню та часом вимірювання. Модель і вимірювання можуть розбігатися навіть удвічі.\n• Без зв’язку показується останній збережений прогноз, завжди й із часом завантаження. Старший за шість годин позначається помаранчевим.\n\nСонце, місяць і припливи:\n• Схід, захід сонця та фаза місяця обчислюються на пристрої — інтернет не потрібен\n• Натисніть оновити на картці Приплив/відплив, щоб завантажити 7-денний прогноз (безкоштовно, без API-ключа)\n• Припливи кешуються й лишаються доступними офлайн; картка попередить, якщо прогноз старий або завантажений далеко звідси\n• ⚠ Висоти припливу подано над середнім рівнем моря, а не над нулем карти — ніколи не використовуйте їх для глибини під кілем\n\nМорська течія:\n• Картка Морська течія показує реальний прогноз для вашої позиції у вузлах і напрямок, КУДИ тече течія\n• Не плутайте з шаром Океанічні течії — це довідкова карта великих глобальних течій';
  ...
  String get guideSafetyMobBody =>
      'Вкладка Безпека містить функції екстреної допомоги.\n\nМЗБ (Людина за бортом):\n• Утримуй червону кнопку МЗБ для активації\n• Додаток записує GPS-позицію та відраховує час і відстань\n• Навігація назад до місця падіння\n\nЯкірна сигналізація:\n• Встанови радіус стоянки (рекомендовано: 2× довжина ланцюга)\n• Сигналізація вібрує, якщо судно виходить за допустимий радіус\n• Якірна вахта тепер записує власний трек, тож ніч на якорі вже не дірка в GPX. Це окрема ділянка — вона ніколи не йде до миль, денної відстані чи нічних годин: гойдання на ланцюгу — це не плавання.\n• Вахта переживає перезапуск застосунку: якщо система вбиває його у фоні, після запуску вона продовжує на тому самому якорі.\n• Записи про віддачу та вибирання якоря тепер несуть і вітер, тиск, температури, глибину під кілем і рушій — досі там був лише час і позиція.\n• Якірна вахта пише трек навіть тоді, коли жодне плавання не записується — це окремий відрізок поза милями й поза денною відстанню, але він потрапляє у GPX, а картка дня показує, коли вахта працювала, скільки точок записала і який був найбільший відхід від якоря.';
  ...
  String get guideSafetyBriefingBody =>
      'Вкладка Безпека також містить довідкові картки.\n\n• Інструктаж з безпеки – чекліст для екіпажу перед відплиттям\n• Кожен член екіпажу підписується власним підписом на екрані\n• Підписи зберігаються та автоматично включаються до PDF-експорту плавання\n• Чекліст передачі судна – огляд пунктів прийому/повернення, доступний навіть без відкритого рейсу\n• Картка MAYDAY – процедура виклику допомоги на каналі 16 ОВЧ\n• МППЗС – правила запобігання зіткненням на морі (доступно словацькою та англійською; інші мови показують англійський текст)\n• Екстрені контакти – номери і контакти для надзвичайних ситуацій\n\nПримітка: трекінг можна запустити будь-коли, навіть без завершеного інструктажу – застосунок лише нагадає чипом \"Немає інструктажу з безпеки\" в Журналі, доки його не завершиш. Інструктаж вимагає спершу заповненої картки судна та екіпажу і зберігається лише після підписів усіх членів.\n• Екстрені контакти визначаються за поточною позицією навіть без трасування — застосунок сам запитує позицію і змінює номери при перетині кордону\n• До брифінгу та до обох актів можна дописати власний пункт — що судно має понад список або чого вимагає чартерна компанія. Власні пункти застосунок пам\'ятає для наступних плавань і для кожного наступного акта, а додати й видалити їх можна в обох місцях — у Безпеці та в плаванні. У PDF акта вони друкуються поруч зі сталими позиціями. Брифінг у плаванні — це той самий список, який читаєш у Безпеці: розділи довідника, пункт за пунктом. Сталі пункти з довідника видалити не можна, власні можна.';

  @override
  String get guideDutyTitle => 'Вахта екіпажу';

  @override
  String get guideDutyBody =>
      'Запис про те, хто і коли був на вахті — у розділі Безпека, над якірною тривогою.\n\n• Заступити на вахту — вибери одну або кількох осіб одразу; кожна потім завершує вахту окремо\n• Імена беруться з екіпажу рейсу. Якщо екіпаж не заданий, кнопка приведе до картки рейсу\n• Час заступання можна виправити, якщо ти натиснув пізніше\n• Показати для перевірки — повноекранна картка для перевірки на борту: хто на вахті, з якого часу, місцевий час і UTC. Змінити з неї нічого не можна\n• Графік вахт — додати вахту заднім числом або відредагувати. Якщо не заповниш час «до», вахта триває далі\n• Нічна вахта через опівніч — це один запис, а не два. У PDF вона з’явиться в обидва дні, позначена стрілкою\n• Заступання і завершення записуються в журнал і в PDF-експорт\n\nПримітка: застосунок ніколи не завершує вахту сам. Через 12 годин лише попередить — час завершення, якого ти не бачив, був би вигаданим.';
  ...
  String get guideCompassBody =>
      'Вкладка Компас показує магнітний пеленг за допомогою сенсорів телефону, з виглядом задньої камери як тло для пеленгування об\'єктів.\n\n• Жовтий приціл – напрям, на який ви вказуєте\n• Компасна смуга вгорі – N / NE / E / SE / S / SW / W / NW\n• Числовий показник – градуси та сторона світу\n• Зелена точка = стабільне показання  ·  Помаранчева точка = калібрується\n\nЯкщо показник нестабільний, повільно рухай телефоном у формі вісімки для калібрування магнетометра.\n\nУвага: точність може знижуватись поблизу металевих конструкцій, динаміків або електроніки.\n\nКомпас вирішує два різні завдання — знайти СЕБЕ, коли не знаєш, де ти, або визначити НЕВІДОМУ ТОЧКУ, коли хочеш нанести на карту те, чого там ще немає. Перемикач над кнопкою Взяти пеленг обирає, яке з них ти зараз робиш.\n\nМОЯ ПОЗИЦІЯ — знайди себе (GPS не потрібен)\n\n1. Перевір на карті, чи знаєш ти принаймні дві видимі точки (маяк, вершину, церкву), збережені як waypoints. Точку, якої бракує, додаєш довгим утриманням на карті точно в її місці.\n2. На компасі перемкнись на \"Моя позиція\".\n3. Торкнись мітки під перемикачем і вибери першу точку, яку пеленгуєш.\n4. Наведи приціл точно на неї і натисни Взяти пеленг.\n5. Перевір зміряний пеленг у діалозі й натисни Зберегти (Скасувати відкидає чернетку без збереження).\n6. Вибери другу, ІНШУ точку (вибір сам очищується після збереження) і повтори.\n7. На карті побачиш дві штрихові лінії від точок до тебе. Їхній перетин — твоя позиція: зелений хрестик означає добрий перетин, помаранчевий — гострий кут і непевну позицію.\n8. Третя точка, найкраще під іншим кутом, уточнює оцінку і малює трикутник похибки.\n\nЗроби це швидко, протягом 5 хвилин — визначення позиції припускає, що судно між пеленгами стоїть.\n\nНЕВІДОМА ТОЧКА — визнач об\'єкт (потрібен GPS)\n\n1. Перемкнись на \"Невідома точка\".\n2. Торкнись мітки, обери \"Нова точка…\" і назви те, що пеленгуєш, наприклад \"невідома скеля\".\n3. Наведи, Взяти пеленг, підтверди Зберегти.\n4. Перемісти судно щонайменше на кілька сотень метрів — що далі, то надійніший результат.\n5. Знову відкрий вибір цілі, вибери ТОЙ САМИЙ об\'єкт зі списку (не \"Нова точка\") і візьми пеленг вдруге.\n6. На карті з\'явиться позначка з обчисленою позицією об\'єкта. Торкнись, щоб зберегти її як waypoint — відтоді її можна використати й для визначення позиції.\n\nТочність\n\nКомпас у телефоні має реальну похибку близько ±8°, що на 10 морських милях дає понад 2,5 милі бокового відхилення — саме тому застосунок малює конус похибки замість тонкої лінії. Найкращий перетин дають точки під кутом, близьким до 90°; коли вони лежать майже на одній лінії з тобою, перетин розмивається на сотні метрів і більше.\n\nПеленги без плавання\n\nПеленг зберігається навіть без увімкненого трекінгу — на якорі, на березі. Знайдеш його у списку плавань як окремий рядок з датою, між окремими плаваннями. Відкривши його, побачиш пеленги того дня з невеликою картою, і звідти можна експортувати простий PDF із картою та таблицею пеленгів.\n\nОчищення карти та видалення пеленгів\n\nПеленгування на чистій карті – на Компасі піктограма оновлення вгорі праворуч. Прибирає з карти наявні пеленги й скидає обрану точку чи об\'єкт, тож наступне Взяти пеленг починається з чистого аркуша. Нічого не втрачається: записи лишаються у вкладці Судновий журнал і в експорті PDF.\n\nОстаточне видалення – відкрий рядок з датою у списку плавань. Хрестик біля рядка видаляє один пеленг (для об\'єкта — весь набір пеленгів на нього). Кошик у верхній панелі видаляє цілий день одразу й повертає тебе до списку. Видалення незворотне, і ці пеленги зникають також з експорту PDF.\n\nСтисло: очищення впорядковує карту, видалення прибирає запис. Вміст PDF змінює лише видалення.';
  ...
  String get guideSettingsBody =>
      '• Мова – змінити мову додатку\n• Прилади – налаштувати IP-адресу WiFi-шлюзу Raymarine (TCP чи UDP)\n• Джерело GPS – телефон або Raymarine\n• Одиниці – відстань мор. милі/км, швидкість вузли/км/год, окремо температура, глибина і вітер (на річці зручні км + км/год)\n• Частота записів у журнал\n• Відображення – нічний режим (червоний фільтр для збереження нічного зору)\n• Нижнє меню – налаштовується: утримуйте та перетягуйте іконку для зміни порядку, перемикачем приховайте вкладки, якими не користуєтесь, і виберіть розмір іконок (S/M/L). Приховані вкладки відкриваються тут у Налаштуваннях; Налаштування показуються завжди. Порядок і розмір запам’ятовуються. Підписи під іконками сховані, щоб іконки стояли однаково в усіх мовах; утримуй іконку, щоб побачити назву.\n• Хмарний експорт (Google Drive) – після входу PDF і GPX кожного завершеного дня автоматично завантажуються на ваш власний Google Drive. Без входу все залишається на пристрої.\n• Резервна копія даних – див. \"Резервна копія та відновлення даних\"\n• Про додаток – версія та контакт\n• Батарея – GPS працює з повною точністю лише там, де точне положення справді потрібне (запис плавання, карта, компас, прилади, якірна вахта, MOB); в інших випадках переходить в економний режим, а у фоні без увімкненого запису вимикається повністю. Коли підключені суднові прилади, GPS телефона лишається вимкненим, а положення надходить з NMEA.\n• Оновлення – коли в Google Play є новіша версія, застосунок завантажує її у фоновому режимі й пропонує перезапуск. Під час запису плавання не питає ніколи.\n• Часовий пояс – час на екрані та в PDF показується або місцевий (пояс телефона, тобто там, де ти є), або UTC. Збережені записи не змінюються, змінюється лише відображення; PDF завжди зазначає, який пояс діє.\n\nАкаунт Google та експорт у хмару\n\nВхід через акаунт Google є добровільним. Без нього застосунок працює повністю, а всі записи залишаються лише в телефоні.\n\nЩо завантажується – після завершення дня плавання PDF журналу та GPX-трек того дня. Більше нічого: жодних фото, жодних контактів екіпажу, жодних позицій у реальному часі.\n\nКуди – на твій власний Google Диск, у папку HMB_Sailing_Log_DATA / назва плавання / Day_дата. Не на сервер застосунку – його немає.\n\nЩо застосунок бачить на Диску – лише файли, які сам там створив. Він використовує найвужчий дозвіл, який пропонує Google (drive.file), тож решта твого Диска залишається недосяжною.\n\nЯк це скасувати – вийди з акаунта в Налаштуваннях. Файли, які вже на Диску, залишаються твоїми – застосунок їх не видаляє.\n• Оцінити додаток — відкриває його сторінку в Google Play. Додаток іноді питає й сам, але лише після завершеного плавання, ніколи під час нього.\n• Якірна тривога: обери звук будь-який будильник чи дзвінок у телефоні через системний вибір і гучність та послухай зразок, поки він не знадобився. Звук іде через канал тривоги, тож його чути навіть на беззвучному телефоні; гучність можна зменшити, але не вимкнути.';
  ...
  String get guideExportBody =>
      'Журнал можна експортувати як професійний PDF-документ.\n\n1. У Журналі натисни чип Експорти вгорі\n2. Обери, що експортуєш — усе плавання, один день, акт приймання, свідоцтва екіпажу, милі або пеленги\n3. Підпиши як шкіпер → PDF створюється\n4. PDF містить: маршрут, записи, фото, титульна сторінка з фото судна з картки судна (якщо завантажене), інструктаж з безпеки з підписами екіпажу\n5. Поділись електронною поштою, роздрукуй або збережи на телефоні\n\nКожен PDF отримує унікальний ID документа (напр. HMBSL-5-2026) та номер ревізії (Rev. 1, Rev. 2...) видимий у підвалі кожної сторінки. Кожен новий експорт автоматично збільшує номер — так видно, скільки разів документ було згенеровано.\n\nQR-код на сторінці підпису містить ID, ревізію та криптографічний відбиток вмісту. Будь-яка зміна даних змінює QR-код.\n\nPDF створюється мовою, налаштованою в застосунку, разом з іменами та діакритикою. На сторінці кожного дня є також огляд вахт екіпажу.\n• Якщо трасування протягом дня переривалося і запускалося знову, кожен відрізок отримає власний GPX-файл\n• Відстані, швидкості та температури в PDF відповідають одиницям, налаштованим у Налаштуваннях\n• Усі експорти в одному місці — під чипом Експорти в Журналі. Єдиний виняток — резервна копія всієї бази: вона лишається в Налаштуваннях поруч із відновленням, бо це не документ для когось, а образ даних.\n• Перед експортом можна вибрати підкладку фрагмента карти — супутник або звичайну карту. Вибір запам\'ятовується. Фрагмент завжди трохи ширший за сам трек, щоб було видно околиці; день на одному місці дістає вікно щонайменше кілометр, інакше в документі були б самі дахи.\n• Інструктаж з безпеки можна експортувати окремо — окремий PDF із підписами екіпажу та переліком опрацьованих пунктів. Він є в Експортах і на екрані інструктажу; у підсумку плавання все залишається як було.\n• Перша сторінка експорту плавання тепер несе карту всього плавання, над списком днів. Денні врізки лишаються, де були — це та одна лінія від початку до кінця, яку з них скласти не виходило.';

  @override
  String get safetyBriefingScreenTitle => 'Інструктаж з безпеки';

  @override
  String get pdfBriefingPoints => 'Пункти інструктажу';

  @override
  String pdfBriefingCovered(int done, int total) {
    return 'Опрацьовано: $done з $total';
  }

  @override
  String get pdfBriefingNotCovered => 'Не опрацьовано';

  @override
  String get exportsBriefingDesc => 'Підписи екіпажу та опрацьовані пункти';

  @override
  String get briefingExportPdf => 'Експорт PDF інструктажу';
  ...
  @override
  String get vesselPickSaved => 'Вибрати з моїх суден';

  @override
  String get vesselOwnLabel => 'Власне судно';

  @override
  String get vesselOwnHint =>
      'Зберігається вгорі списку суден, щоб наступне плавання заповнилося саме.';

  @override
  String get vesselNoneSaved =>
      'Ще немає збереженого судна — воно збережеться разом із плаванням.';

  @override
  String get briefingAddOwnItem => 'Додати власний пункт';

  @override
  String get safetyOwnPoints => 'Власні пункти';

  @override
  String get briefingOwnItemHint => 'Новий пункт брифінгу';

  @override
  String get checklistAddOwnItem => 'Додати власну позицію';
  ...
  @override
  String get charterPriceLabel => 'Ціна плавання';
  ...
  @override
  String get costBaseCharter => 'Базова ціна плавання';
  ...
  @override
  String get interruptedVoyageTitle => 'Трасування було перервано';

  @override
  String interruptedVoyageBody(String time) {
    return 'Застосунок закрився о $time без завершення плавання. Продовжити те саме плавання?';
  }

  @override
  String interruptedVoyageGap(String distance) {
    return 'Поточна позиція за $distance мор. миль від останньої записаної точки.';
  }

  @override
  String get interruptedVoyageAddGap => 'Долічити цю відстань до плавання';
  ...
  String get batteryPromptBody =>
      'Android — особливо Honor, Huawei та Xiaomi — закриває застосунки у фоні, і трасування переривається посеред плавання.\n\nУ налаштуваннях батареї дозвольте цьому застосунку працювати без обмежень. На Honor/Huawei додайте його до захищених застосунків і дозвольте автозапуск.';

  @override
  String get batteryPromptAction => 'Відкрити налаштування';

  @override
  String get speed => 'Швидкість';

  @override
  String get dateFormatLabel => 'Формат дати';

  @override
  String get dateFormatByLanguage => 'За мовою застосунку';

  @override
  String get crewCertTitle => 'Підтвердження пройдених миль';

  @override
  String get crewCertVoyage => 'Плавання';

  @override
  String get crewCertArea => 'Район плавання';

  @override
  String get crewCertRoute => 'Маршрут';

  @override
  String get crewCertDayMiles => 'Денні милі';

  @override
  String get crewCertNightMiles => 'Нічні милі';

  @override
  String get crewCertNightHours => 'Нічні години';

  @override
  String get crewCertQualifications => 'Кваліфікації';

  @override
  String get crewCertAssessment => 'Оцінка шкіпера';

  @override
  String get crewCertStamp => 'Печатка';

  @override
  String get crewCertHashCoverage =>
      'Відбиток охоплює підсумок плавання та оцінку екіпажу.';

  @override
  String get crewSkillHelming => 'Стернування';

  @override
  String get crewSkillNavigation => 'Навігація';

  @override
  String get crewSkillHarbour => 'Маневри в порту';

  @override
  String get crewSkillTeamwork => 'Робота в команді';

  @override
  String get crewSkillNightSailing => 'Нічне плавання';

  @override
  String get crewCertExport => 'Експортувати підтвердження';

  @override
  String get crewCertNoteHint => 'Словесна оцінка (необов’язково)';

  @override
  String get crewCertNoCrew =>
      'Це плавання не має екіпажу. Додайте його в картці плавання.';

  @override
  String get crewCertNotRated => 'не оцінено';
  ...
  @override
  String get crewCertVesselSize => 'Розміри судна';

  @override
  String get crewCertVesselRegistration => 'Реєстрація';

  @override
  String get crewCertWaters => 'Води';

  @override
  String get crewCertWatersTidal => 'припливні';

  @override
  String get crewCertWatersNonTidal => 'неприпливні';

  @override
  String get crewCertIdDocument => 'Номер паспорта / ID';

  @override
  String get crewCertIdNotStored =>
      'Номер не зберігається — його надрукує лише це свідоцтво.';

  @override
  String get crewCertDaysAtSea => 'Дні в морі';

  @override
  String get crewCertTotal => 'Разом';
  ...
  String get bearingsDeleteDayConfirm =>
      'Усі пеленги цього дня будуть остаточно видалені, зокрема з PDF-експорту. Цю дію неможливо скасувати.';
  ...
  String mapApproximatePosition(String meters) {
    return 'Приблизне місцеположення ±$meters м — з мереж Wi-Fi, не з GPS';
  }

  @override
  String get compassUnavailable =>
      'Цей пристрій не має компаса — курс недоступний.';

  @override
  String anchorQuickStarted(String radius) {
    return 'Якірна вахта працює · $radius м';
  }

  @override
  String get anchorQuickStopTitle => 'Зупинити якірну вахту?';

  @override
  String get anchorQuickStopBody =>
      'Вахта зупиниться, а до журналу піде «Якір піднято».';

  @override
  String get mobCancelTitle => 'Скасувати MOB?';

  @override
  String get mobCancelBody =>
      'Тривога стихне, а точку падіння більше не відстежуватимуть.';

  @override
  String get anchorSoundLabel => 'Звук тривоги';

  @override
  String get anchorVolumeLabel => 'Гучність тривоги';

  @override
  String get anchorSoundPreview => 'Відтворити зразок';

  @override
  String get anchorSoundPreviewDesc =>
      'Звук, якого ти ніколи не чув, о третій ночі не скаже «якір».';

  @override
  String anchorWatchDaySummary(String range, String points, String swing) {
    return 'Якірна вахта $range · $points точок · найбільший відхід $swing м';
  }

  @override
  String get anchorSoundSystemDefault => 'Звук будильника телефона';

  @override
  String get anchorVolumeDesc =>
      'Це справжня гучність, а не множник: на час тривоги застосунок піднімає канал тривоги телефона до цього рівня, а потім повертає його назад.';

  @override
  String get anchorDndTitle => 'Режим «Не турбувати» перебиває гучність';

  @override
  String get anchorDndBody =>
      'Поки ввімкнено «Не турбувати», дозволити підняття гучності можеш лише ти. Без цього тривога все одно пролунає, але настільки гучно, як налаштовано в телефоні.';

  @override
  String get unassignedMobTitle => 'MOB поза плаванням';

  @override
  String get unassignedAnchorTitle => 'Якір поза плаванням';

  @override
  String get unassignedEventTitle => 'Подія поза плаванням';

  @override
  String get logEventMobCancelled => 'MOB скасовано';
}
