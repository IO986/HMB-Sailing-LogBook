...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get mapOfflineTilesHint =>
      'Χωρίς internet — ο χάρτης δεν θα φορτώσει νέα πλακίδια. Κατέβασε την περιοχή όσο έχεις σήμα.';
  ...
  @override
  String get portFromLabel => 'Λιμάνι αναχώρησης';

  @override
  String get portToLabel => 'Λιμάνι άφιξης';

  @override
  String get routeAutoFillHint =>
      'Συμπληρώνεται αυτόματα από το GPS όταν υπάρχει δίκτυο. Αν έμεινε κενό, συμπλήρωσέ το εδώ.';
  ...
  @override
  String get exportsTitle => 'Εξαγωγές';

  @override
  String get exportMapLayer => 'Υπόβαθρο χάρτη στο απόσπασμα';

  @override
  String get exportMapSatellite => 'Δορυφόρος';

  @override
  String get exportMapPlain => 'Χάρτης';

  @override
  String get exportsThisVoyage => 'Αυτό το ταξίδι';

  @override
  String get exportsAcrossVoyages => 'Σε όλα τα ταξίδια';

  @override
  String get exportsAutomatic => 'Αυτόματα';

  @override
  String get exportsWholeVoyage => 'Ολόκληρο το ταξίδι';

  @override
  String get exportsWholeVoyageDesc =>
      'Όλες οι ημέρες με χάρτες, πλήρωμα και υπογραφές';

  @override
  String get exportsDay => 'Ημέρα';

  @override
  String get exportsDayDesc => 'Μία ημέρα του ταξιδιού μαζί με το ίχνος';

  @override
  String get exportsHandoverDesc =>
      'Πρωτόκολλο παραλαβής και παράδοσης σκάφους';

  @override
  String get exportsCrewCertsDesc => 'Μίλια και αξιολόγηση, ένα ανά μέλος';

  @override
  String get exportsMilesCertDesc => 'Μίλια από τα ταξίδια που επιλέγεις';

  @override
  String get exportsBearingsDesc => 'Διοπτεύσεις εκτός ταξιδιού';

  @override
  String get exportsCloudTitle => 'Εξαγωγή στο Google Drive';

  @override
  String get exportsCloudOn => 'Ενεργή — η ολοκληρωμένη ημέρα φεύγει μόνη της';

  @override
  String get exportsCloudOff => 'Ανενεργή — όλα μένουν στο τηλέφωνο';
  ...
  @override
  String get exportsPickVoyage => 'Διάλεξε ταξίδι';

  @override
  String get exportsNoVoyages => 'Κανένα ταξίδι ακόμη';

  @override
  String get exportsNoDays => 'Αυτό το ταξίδι δεν έχει καταγεγραμμένη ημέρα';

  @override
  String get exportsNoBearings => 'Καμία διόπτευση εκτός ταξιδιού';

  @override
  String get exportsNotFilledIn => 'Δεν έχει συμπληρωθεί';
  ...
  @override
  String get pdfMilesTitle => 'Πιστοποιητικό διανυθέντων μιλίων';
  ...
  @override
  String get milesExportPickCrew => 'Επιλογή από το πλήρωμα';
  ...
  @override
  String get autoEntryNote => 'Αυτόματη εγγραφή';

  @override
  String get logEventSailChange => 'Αλλαγή πορείας πανιών';

  @override
  String get logEventCourseChange => 'Αλλαγή πορείας';

  @override
  String get pdfNightShort => 'νύχτα';

  @override
  String nightSailingHours(String hours) {
    return 'Νυχτερινή πλεύση $hours h';
  }

  @override
  String logEventSailChangeTo(String direction) {
    return 'Αλλαγή πορείας πανιών: $direction';
  }
  ...
  String logEventAutopilotOn(String mode) {
    return 'Αυτόματος πιλότος ON - $mode';
  }

  @override
  String get logEventAutopilotOff => 'Αυτόματος πιλότος OFF';

  @override
  String get logEventEngineStart => 'Η μηχανή ξεκίνησε';

  @override
  String get logEventEngineStop => 'Η μηχανή σταμάτησε';

  @override
  String get updateDownloaded => 'Η ενημέρωση κατέβηκε';

  @override
  String get updateRestart => 'Επανεκκίνηση';
  ...
  @override
  String get autopilotModeWind => 'Άνεμος';

  @override
  String get autopilotModeTrack => 'Πορεία';

  @override
  String get autopilotModeHeading => 'Κατεύθυνση';

  @override
  String get autopilotModeRudder => 'Πηδάλιο';

  @override
  String get autopilotModeStandby => 'Αναμονή';
  ...
  String get errorBadResponse =>
      'Η απάντηση του διακομιστή δεν διαβάστηκε. Δοκίμασε ξανά αργότερα.';
  ...
  @override
  String get rateApp => 'Βαθμολόγηση εφαρμογής';

  @override
  String get rateAppDesc => 'Ανοίγει τη σελίδα της εφαρμογής στο Google Play';
  ...
  @override
  String get sailDirection => 'Πορεία ως προς τον άνεμο';

  @override
  String get pointOfSailCloseHauled => 'Όρτσα';

  @override
  String get pointOfSailCloseReach => 'Ανοιχτή όρτσα';

  @override
  String get pointOfSailBeamReach => 'Πλαγιοδρομία';

  @override
  String get pointOfSailBroadReach => 'Ανοιχτή πλαγιοδρομία';

  @override
  String get pointOfSailRunning => 'Πρίμα';

  @override
  String get tackPort => 'Αριστερά';

  @override
  String get tackStarboard => 'Δεξιά';
  ...
  @override
  String get pdfWeatherSourceInstruments => 'Όργανα';
  ...
  @override
  String get pdfWeatherSourceStationUnknown => 'Μετ. σταθμός';

  @override
  String get pdfWeatherSourceModel => 'Μοντέλο';
  ...
  @override
  String get quickNoteHint => 'Τι μόλις συνέβη';

  @override
  String get pickVoyageAction => 'Επιλογή ταξιδιού';
  ...
  String get guideLogbookBody =>
      'Το Ημερολόγιο είναι η κύρια καρτέλα διαχείρισης πλόων.\n\n• Το μεγάλο κουμπί \"Έναρξη Πλου\" στην κορυφή ξεκινά την καταγραφή – ζητά μόνο τη συχνότητα αυτόματης καταγραφής (αλλάζει σε κάθε επανεκκίνηση), χωρίς φόρμα προς συμπλήρωση εκ των προτέρων\n• Αν υπάρχει ήδη ανοιχτός πλους, η εφαρμογή ρωτά αν θα τον συνεχίσετε ή θα ξεκινήσετε νέα εγγραφή\n• Τα στοιχεία που λείπουν (παραλαβή, ενημέρωση ασφαλείας, κάρτα σκάφους/πληρώματος) υπενθυμίζονται με χρωματιστές ετικέτες πάνω στην κάρτα του πλου – πατήστε μια ετικέτα για να τα συμπληρώσετε\n• Κάθε ημέρα του πλου εμφανίζεται ξεχωριστά\n• Οι καταχωρήσεις μπορούν να προστεθούν χειροκίνητα κατά τη διάρκεια της ημέρας, μαζί με ώρες μηχανής, καύσιμο και νερό στην ενότητα \"Μηχανή & δεξαμενές\"\n• Κατά την καταγραφή, ένα κουμπί κάμερας (κάτω αριστερά) επιτρέπει να βγάλετε φωτογραφία ενός σημείου ενδιαφέροντος και να την αποθηκεύσετε ως γρήγορη καταχώρηση με θέση και ώρα\n• Το ημερολόγιο μπορεί να εξαχθεί σε PDF μέσω του μενού της ημέρας\n• Το εικονίδιο χειραψίας στη λεπτομέρεια του πλου ανοίγει το πρωτόκολλο παράδοσης (παραλαβή/παράδοση)\n• Η αναλυτική φόρμα πλου (εικονίδιο σκάφους στη λεπτομέρεια) καταγράφει το σκάφος και τις παραμέτρους του, την περιοχή πλου, το πλήρωμα με τις άδειες του κυβερνήτη και φωτογραφίες σκάφους (μέγ. 3, μεταφέρονται στο PDF)\n• Οι ημιτελείς κάρτες (Ενημέρωση Ασφαλείας, παραλαβή/παράδοση, κάρτα σκάφους) αναβοσβήνουν κόκκινες στη λεπτομέρεια του πλου μέχρι να ολοκληρωθούν\n• Αν η εφαρμογή κλείσει στη μέση του ταξιδιού χωρίς να σταματήσει η καταγραφή (την τερματίσει το σύστημα, κατά λάθος swipe), στην επόμενη εκκίνηση προτείνει τη συνέχιση του ίδιου ταξιδιού – μαζί με την απόσταση που διανύθηκε όσο δεν έτρεχε\n• Την πρώτη φορά που ξεκινάς ταξίδι η εφαρμογή υπενθυμίζει τις ρυθμίσεις μπαταρίας – χωρίς αυτές το σύστημα (κυρίως Honor/Huawei) μπορεί να διακόψει την καταγραφή στο παρασκήνιο\n• Το εικονίδιο διαδρομής στην κεφαλίδα του ταξιδιού (δίπλα στο briefing, το πρωτόκολλο και την κάρτα σκάφους) δείχνει όλη τη διαδρομή στον χάρτη\n• Μετά το ταξίδι μπορείς να εξάγεις βεβαίωση μιλίων για κάθε μέλος του πληρώματος – ημέρες στη θάλασσα, ημερήσια και νυχτερινά μίλια, περιοχή, αξιολόγηση κυβερνήτη και QR για επαλήθευση\n• Ο τρόπος πρόωσης (μηχανή/πανιά) περνά και στις αυτόματες εγγραφές – τον ορίζεις μία φορά και οι επόμενες τον κρατούν\n• Η βεβαίωση είναι δίγλωσση (η γλώσσα σου + αγγλικά), περιέχει διαστάσεις και νηολόγηση σκάφους, τον τύπο υδάτων (παλιρροϊκά/μη) και πεδίο για αριθμό διαβατηρίου ή ταυτότητας· μπορείς να τη μοιραστείς ή να την αποθηκεύσεις στο τηλέφωνο\n• Πορεία ως προς τον άνεμο – η σιλουέτα του σκάφους από το χάρτινο ημερολόγιο: πάτησε την πορεία στην πλευρά από την οποία έρχεται ο άνεμος (αριστερά κόκκινο, δεξιά πράσινο). Η πρίμα βρίσκεται κάτω, εκεί δεν υπάρχει πλευρά. Νέο πάτημα καθαρίζει την επιλογή – μια εικασία είναι χειρότερη από ένα κενό πεδίο. Μπαίνει στο PDF δίπλα στην πρόωση.\n• Κατά την καταγραφή, ένα δεύτερο γρήγορο κουμπί (εικονίδιο ιστιοπλοΐας, κάτω αριστερά) καταγράφει αναστροφή ή υποστροφή: διάλεξε τη νέα πορεία στη σιλουέτα και η εγγραφή γράφεται με θέση και ώρα. Οι επόμενες αυτόματες εγγραφές κρατούν αυτή την πορεία μέχρι να την αλλάξεις ξανά.\n• Το βάθος από το βυθόμετρο αποθηκεύεται στις αυτόματες καταχωρίσεις και προσυμπληρώνεται στη χειροκίνητη (απαιτεί συνδεδεμένα όργανα).\n• Οι ώρες μηχανής μετρούνται από τις στροφές των οργάνων και η εκκίνηση ή η παύση της μηχανής καταγράφεται μόνη της στο ημερολόγιο.\n• Το γρήγορο κουμπί με το ιστιοφόρο (κάτω αριστερά κατά τον πλου) καταγράφει τώρα και την πρόωση — Μηχανή / Μαΐστρα / Τζένοα / Μούδα. Οι επόμενες αυτόματες εγγραφές τη συνεχίζουν μέχρι να την αλλάξεις, οπότε η στήλη Πρόωση στο PDF δεν μένει πια κενή.\n• Η εφαρμογή καταγράφει μόνη της την αλλαγή πορείας: όταν η πορεία αποκλίνει κατά 30° ή περισσότερο και κρατά τη νέα κατεύθυνση τουλάχιστον ένα λεπτό. Οι ταλαντεύσεις στο κύμα ή ένα τίναγμα του GPS δεν την ενεργοποιούν.\n• Οι αυτόματες εγγραφές φέρουν και την κατάσταση του ουρανού — συμπληρώνεται από το μοντέλο για την ώρα και τη θέση της εγγραφής, όπως ο άνεμος και η πίεση.\n• Ο νυχτερινός πλους υπολογίζεται μόνος του, από την πραγματική δύση και ανατολή για τη θέση του σκάφους. Μια εγγραφή μετά το σκοτάδι φέρει φεγγάρι, ενώ η ημέρα και ολόκληρος ο πλους φέρουν το σύνολο των νυχτερινών ωρών, στο ημερολόγιο και στο PDF.\n• Νέο πλού ξεκινάς με το κουμπί **Νέος πλούς** στο Ημερολόγιο — συμπληρώνεις σκάφος, περιοχή και πλήρωμα πριν τον απόπλου και η καταγραφή συνδέεται με αυτόν. Το κουμπί Έναρξη λειτουργεί όπως πριν.\n• Η διαδρομή της ημέρας (από → προς) συμπληρώνεται από το GPS, αλλά μόνο με λειτουργικό internet — στο WiFi των οργάνων το τηλέφωνο δεν έχει, οπότε τα λιμάνια μπορεί να μείνουν κενά. Η εφαρμογή τα συμπληρώνει αργότερα μόνη της, ενώ μπορείς πάντα να τα γράψεις πατώντας τη διαδρομή στην κάρτα της ημέρας. Όπου λείπει λιμάνι, το PDF τυπώνει τη θέση αντί για ερωτηματικό.\n• Η πρόωση ξεκινά ως Μηχανή: από το λιμάνι αποπλέεις με μηχανή, και μια κενή στήλη Πρόωσης δεν ήταν ποτέ πιο αληθινή από τη Μηχανή, μόνο πιο δυσανάγνωστη. Η πρώτη αλλαγή (γρήγορο κουμπί ή χειροκίνητη καταχώρηση) την αντικαθιστά και οι επόμενες αυτόματες καταχωρήσεις τη συνεχίζουν.\n• Ένα σκάφος μπορεί να μείνει στη λίστα σκαφών — το «Διάλεξε ένα από τα σκάφη μου» στην κάρτα του ταξιδιού συμπληρώνει το επόμενο ταξίδι με ένα πάτημα, μαζί με μοντέλο, διακριτικό, MMSI, διαστάσεις και δεξαμενές. Αποθηκεύεται μαζί με το ταξίδι· τσέκαρε «δικό μου σκάφος» και θα βρίσκεται πρώτο. Το ταξίδι κρατά δικό του αντίγραφο, οπότε αλλαγή στη λίστα δεν αλλάζει υπογεγραμμένο έγγραφο.\n• Στο γρήγορο πάνελ αλλαγής πανιών υπάρχει και κουμπί Γρήγορη σημείωση — γράφεις μια πρόταση και η καταχώρηση αποθηκεύεται με ό,τι ξέρει η εφαρμογή (θέση, ώρα, ταχύτητα, πορεία, άνεμος, πίεση, θερμοκρασίες, βάθος, πρόωση). Το ίδιο με τη γρήγορη φωτογραφία, χωρίς τη φωτογραφία.\n• Όταν είναι ανοιχτά πολλά ταξίδια μαζί (στην εκπαίδευση ένα ανά μαθητή), η ερώτηση στην εκκίνηση έχει τρίτη επιλογή — Επιλογή ταξιδιού — και συνεχίζει αυτό που διαλέγεις, όχι αυτόματα το νεότερο.';
  ...
  String get guideSafetyMobBody =>
      'Η καρτέλα Ασφάλεια περιέχει λειτουργίες έκτακτης ανάγκης.\n\nMOB (Άνθρωπος στη θάλασσα):\n• Κρατήστε το κόκκινο κουμπί MOB για ενεργοποίηση\n• Η εφαρμογή καταγράφει τη θέση GPS και παρακολουθεί χρόνο και απόσταση\n• Πλοηγηθείτε πίσω στο σημείο πτώσης\n\nΣυναγερμός άγκυρας:\n• Ρυθμίστε την ακτίνα της άγκυρας (συνιστάται: 2× το μήκος αλυσίδας/σκοινιού)\n• Ο συναγερμός δονείται αν το σκάφος εκτραπεί εκτός της επιτρεπόμενης ακτίνας\n• Η αγκυροφυλακή καταγράφει πλέον δικό της ίχνος, ώστε μια νύχτα στην άγκυρα να μην είναι πια κενό στο GPX. Είναι ξεχωριστό τμήμα — δεν προσμετράται ποτέ στα μίλια, στην απόσταση της ημέρας ούτε στις νυχτερινές ώρες, γιατί το στρίψιμο στην αλυσίδα δεν είναι πλους.\n• Η φυλακή επιζεί την επανεκκίνηση της εφαρμογής: αν το σύστημα την κλείσει στο παρασκήνιο, μετά την εκκίνηση συνεχίζει στην ίδια άγκυρα.\n• Οι εγγραφές ρίψης και ανάσυρσης άγκυρας φέρουν πλέον άνεμο, πίεση, θερμοκρασίες, βάθος κάτω από την καρίνα και πρόωση — ώς τώρα είχαν μόνο ώρα και θέση.\n• Η φυλακή άγκυρας καταγράφει το ίχνος ακόμη κι όταν δεν καταγράφεται κανένας πλους — έχει δικό της τμήμα, εκτός των μιλίων και της απόστασης της ημέρας, αλλά μπαίνει στο GPX και η κάρτα της ημέρας δείχνει πότε λειτούργησε, πόσα σημεία έγραψε και τη μεγαλύτερη ταλάντωση από την άγκυρα.';
  ...
  String get guideExportBody =>
      'Το ημερολόγιο μπορεί να εξαχθεί ως επαγγελματικό έγγραφο PDF.\n\n1. Στο Ημερολόγιο πάτησε το chip Εξαγωγές επάνω\n2. Διάλεξε τι εξάγεις — ολόκληρο το ταξίδι, μία ημέρα, το πρωτόκολλο παράδοσης, τα πιστοποιητικά πληρώματος, τα μίλια ή τις διοπτεύσεις\n3. Υπογράψτε ως κυβερνήτης → δημιουργείται το PDF\n4. Το PDF περιλαμβάνει: ίχνος, καταχωρήσεις ημερολογίου, φωτογραφίες, ενημέρωση ασφαλείας με υπογραφές πληρώματος· η κεφαλίδα της σελίδας τίτλου δείχνει τη φωτογραφία του σκάφους από την κάρτα σκάφους (αν έχει ανέβει)\n5. Μοιραστείτε μέσω email, εκτυπώστε ή αποθηκεύστε στο τηλέφωνο\n\nΚάθε PDF λαμβάνει μοναδικό αναγνωριστικό εγγράφου (π.χ. HMBSL-5-2026) και αριθμό αναθεώρησης (Rev. 1, Rev. 2...) ορατό στο υποσέλιδο κάθε σελίδας. Κάθε νέα εξαγωγή αυξάνει αυτόματα τον αριθμό — καθιστώντας ορατό πόσες φορές δημιουργήθηκε το έγγραφο.\n\nΟ κωδικός QR στη σελίδα υπογραφών περιέχει το αναγνωριστικό, την αναθεώρηση και ένα κρυπτογραφικό αποτύπωμα του περιεχομένου. Οποιαδήποτε αλλαγή στα δεδομένα αλλάζει τον κωδικό QR.\n\nΤο PDF δημιουργείται στη γλώσσα της εφαρμογής, με ονόματα και τόνους. Κάθε σελίδα ημέρας φέρει επίσης μια λωρίδα πληρώματος σε βάρδια.\n• Αν η καταγραφή διακόπηκε και ξεκίνησε ξανά μέσα στην ημέρα, κάθε σκέλος παίρνει δικό του αρχείο GPX\n• Οι αποστάσεις, οι ταχύτητες και οι θερμοκρασίες στο PDF ακολουθούν τις μονάδες που έχουν οριστεί στις Ρυθμίσεις\n• Όλες οι εξαγωγές βρίσκονται σε ένα σημείο — στο chip Εξαγωγές του Ημερολογίου. Μοναδική εξαίρεση είναι το αντίγραφο ασφαλείας όλης της βάσης: μένει στις Ρυθμίσεις δίπλα στην επαναφορά, γιατί δεν είναι έγγραφο για κάποιον αλλά αποτύπωση των δεδομένων.\n• Πριν την εξαγωγή διαλέγεις το υπόβαθρο του αποσπάσματος — δορυφόρο ή απλό χάρτη. Η επιλογή θυμάται. Το απόσπασμα είναι πάντα λίγο ευρύτερο από το ίχνος ώστε να φαίνεται ο περίγυρος· μια μέρα σε ένα σημείο παίρνει παράθυρο τουλάχιστον ενός χιλιομέτρου, αλλιώς το έγγραφο θα έδειχνε μόνο στέγες.\n• Η ενημέρωση ασφάλειας μπορεί να εξαχθεί και ξεχωριστά — δικό της PDF με τις υπογραφές του πληρώματος και τη λίστα των σημείων που καλύφθηκαν. Βρίσκεται στις Εξαγωγές και στην οθόνη της ενημέρωσης· στη σύνοψη του ταξιδιού όλα μένουν όπως ήταν.\n• Η πρώτη σελίδα της εξαγωγής του πλου φέρει τώρα χάρτη ολόκληρου του πλου, πάνω από τη λίστα των ημερών. Οι ημερήσιοι χάρτες μένουν όπου ήταν — αυτή είναι η μία γραμμή από την αρχή ως το τέλος, που από εκείνους δεν έβγαινε.';

  @override
  String get safetyBriefingScreenTitle => 'Ενημέρωση Ασφαλείας';

  @override
  String get pdfBriefingPoints => 'Σημεία ενημέρωσης';

  @override
  String pdfBriefingCovered(int done, int total) {
    return 'Καλύφθηκαν: $done από $total';
  }

  @override
  String get pdfBriefingNotCovered => 'Δεν καλύφθηκε';

  @override
  String get exportsBriefingDesc =>
      'Υπογραφές πληρώματος και τα σημεία που καλύφθηκαν';

  @override
  String get briefingExportPdf => 'Εξαγωγή PDF ενημέρωσης';
  ...
  @override
  String get vesselPickSaved => 'Διάλεξε ένα από τα σκάφη μου';

  @override
  String get vesselOwnLabel => 'Δικό μου σκάφος';

  @override
  String get vesselOwnHint =>
      'Αποθηκεύεται στην κορυφή της λίστας, ώστε το επόμενο ταξίδι να συμπληρωθεί μόνο του.';

  @override
  String get vesselNoneSaved =>
      'Δεν έχει αποθηκευτεί σκάφος ακόμη — αποθηκεύεται μαζί με το ταξίδι.';

  @override
  String get briefingAddOwnItem => 'Πρόσθεσε δικό σου σημείο';

  @override
  String get safetyOwnPoints => 'Δικά σου σημεία';

  @override
  String get briefingOwnItemHint => 'Νέο σημείο ενημέρωσης';

  @override
  String get checklistAddOwnItem => 'Πρόσθεσε δική σου καταχώρηση';
  ...
  @override
  String get crewCertTitle => 'Πιστοποιητικό διανυθέντων μιλίων';
  ...
  @override
  String get crewCertRoute => 'Διαδρομή';
  ...
  String get crewCertIdNotStored =>
      'Ο αριθμός δεν αποθηκεύεται — τυπώνεται μόνο σε αυτό το πιστοποιητικό.';
  ...
  String mapApproximatePosition(String meters) {
    return 'Κατά προσέγγιση θέση ±$meters μ — από Wi-Fi, όχι από GPS';
  }

  @override
  String get compassUnavailable =>
      'Αυτή η συσκευή δεν έχει πυξίδα — η πορεία δεν είναι διαθέσιμη.';

  @override
  String anchorQuickStarted(String radius) {
    return 'Η φυλακή άγκυρας τρέχει · $radius m';
  }

  @override
  String get anchorQuickStopTitle => 'Διακοπή της φυλακής άγκυρας;';

  @override
  String get anchorQuickStopBody =>
      'Η φυλακή σταματά και στο ημερολόγιο μπαίνει «Άγκυρα σηκώθηκε».';

  @override
  String get mobCancelTitle => 'Ακύρωση MOB;';

  @override
  String get mobCancelBody =>
      'Ο συναγερμός σταματά και το σημείο πτώσης παύει να παρακολουθείται.';

  @override
  String get anchorSoundLabel => 'Ήχος συναγερμού';

  @override
  String get anchorVolumeLabel => 'Ένταση συναγερμού';

  @override
  String get anchorSoundPreview => 'Αναπαραγωγή δείγματος';

  @override
  String get anchorSoundPreviewDesc =>
      'Ένας ήχος που δεν άκουσες ποτέ δεν θα πει «άγκυρα» στις τρεις τη νύχτα.';

  @override
  String anchorWatchDaySummary(String range, String points, String swing) {
    return 'Φυλακή άγκυρας $range · $points σημεία · μέγιστη ταλάντωση $swing m';
  }

  @override
  String get anchorSoundSystemDefault => 'Ο ήχος ξυπνητηριού του τηλεφώνου';

  @override
  String get anchorVolumeDesc =>
      'Αυτή είναι η πραγματική ένταση, όχι πολλαπλασιαστής: όσο διαρκεί ο συναγερμός η εφαρμογή ανεβάζει το κανάλι συναγερμού του τηλεφώνου σε αυτό το επίπεδο και μετά το επαναφέρει.';

  @override
  String get anchorDndTitle => 'Η «Μην ενοχλείτε» υπερισχύει της έντασης';

  @override
  String get anchorDndBody =>
      'Όσο είναι ενεργή η «Μην ενοχλείτε», μόνο εσύ μπορείς να επιτρέψεις την αύξηση της έντασης. Χωρίς αυτό ο συναγερμός θα ηχήσει ούτως ή άλλως, στην ένταση που έχει το τηλέφωνο.';

  @override
  String get unassignedMobTitle => 'MOB εκτός πλου';

  @override
  String get unassignedAnchorTitle => 'Άγκυρα εκτός πλου';

  @override
  String get unassignedEventTitle => 'Συμβάν εκτός πλου';

  @override
  String get logEventMobCancelled => 'MOB ακυρώθηκε';
}
