...
void main() {
  ...
  test('onCreate builds a schema matching the current (v22) snapshot', () async {
  ...
  test('migrate v7 to current (v22)', () async {
  ...
  test('migrate v8 to current (v22)', () async {
  ...
  test('migrate v9 to current (v22)', () async {
  ...
  test('migrate v10 to current (v22): handoverProtocols.extraNotes', () async {
  ...
  test('migrate v11 to current (v22): logbook record fields', () async {
  ...
  test('migrate v12 to current (v22): Charters.source', () async {
  ...
  test('migrate v13 to current (v22): extended charter form fields', () async {
  ...
  test('migrate v14 to current (v22): trackPoints location metadata', () async {
  ...
  test('migrate v15 to current (v22): logbookEntries location metadata', () async {
  ...
  test('migrate v16 to current (v22): outbox table', () async {
  ...
  test('migrate v17 to current (v22): tideSnapshots table', () async {
  ...
  test('migrate v18 to current (v22): tide location label + manual flag',
      () async {
  ...
  test('migrate v19 to current (v22): dutyPeriods table', () async {
  ...
  test('migrate v20 to current (v22): logbookEntries.eventType', () async {
  ...
  test('migrate v21 to current (v22): logbookEntries.sailMode', () async {
