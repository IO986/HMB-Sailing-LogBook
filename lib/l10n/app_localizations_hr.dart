...
class AppLocalizationsHr extends AppLocalizations {
  ...
  @override
  String get poiCannotOpen => 'Ne može se otvoriti';
  ...
  @override
  String get playbackTitle => 'Reproduciraj plovidbu';

  @override
  String get playbackSpeed => 'Brzina';

  @override
  String get playbackNoTrack => 'Za ovaj dan nije zabilježena ruta';

  @override
  String playbackAtTime(String time) {
    return 'Stanje u $time';
  }
  ...
  @override
  String get portFromLabel => 'Luka isplovljenja';

  @override
  String get portToLabel => 'Luka uplovljenja';

  @override
  String get routeAutoFillHint =>
      'Popunjava se automatski iz GPS-a kad ima mreže. Ako je ostalo prazno, upiši ovdje.';
  ...
  @override
  String get deleteCharterTitle => 'Obrisati plovidbu?';
  ...
  @override
  String get createFirstCharter => 'Kreiraj svoju prvu plovidbu';
  ...
  @override
  String get exportMapLayer => 'Podloga karte u isječku';
  ...
  @override
  String get pdfTidal => 'plimne';

  @override
  String get pdfNonTidal => 'neplimne';

  @override
  String get pdfMilesIssuedFor => 'Izdano za';

  @override
  String get pdfMilesIssuedBy => 'Izdao';

  @override
  String get pdfMilesOwnRecord => 'Vlastita evidencija odjedrenih milja';

  @override
  String get pdfMilesByRole => 'Milje po funkciji';

  @override
  String get pdfMilesSkipperSummary => 'Skiperski sažetak';

  @override
  String get pdfMilesSkipperConfirms => 'Potvrda zapovjednika plovidbe';

  @override
  String get milesExportTitle => 'Izdaj potvrdu';

  @override
  String get milesExportFor => 'Za koga';

  @override
  String get milesExportForSelf => 'Za sebe';

  @override
  String get milesExportForCrew => 'Za člana posade';

  @override
  String get milesExportRecipient => 'Ime primatelja';

  @override
  String get milesExportPickCrew => 'Odaberi iz posade';

  @override
  String get milesExportIssuer => 'Izdavatelj';

  @override
  String get milesExportQualification => 'Kvalifikacija';

  @override
  String get milesExportVoyages => 'Plovidbe u potvrdi';

  @override
  String get milesExportSelectAll => 'Odaberi sve';

  @override
  String get milesExportSelectNone => 'Poništi odabir';

  @override
  String milesExportChosenSummary(String count, String nm) {
    return 'Odabranih plovidbi: $count  ·  $nm NM';
  }

  @override
  String get milesExportNoVoyages => 'Nije odabrana nijedna plovidba';

  @override
  String get milesTidalWaters => 'Plimne vode';
  ...
  @override
  String get autoEntryNote => 'Automatski zapis';
  ...
  String logEventSailChangeTo(String direction) {
    return 'Promjena jedara: $direction';
  }

  @override
  String get logEventHelmsmanChange => 'Promjena kormilara';

  @override
  String logEventHelmsmanChangeTo(String name) {
    return 'Kormilar: $name';
  }

  @override
  String get crewListEmpty => 'Plovidba nema unesenu posadu.';
  ...
  @override
  String get updateDownloaded => 'Ažuriranje je preuzeto';

  @override
  String get updateRestart => 'Ponovno pokreni';
  ...
  @override
  String get charterCheckCard => 'Plovidba';
  ...
  String get errorBadResponse =>
      'Odgovor poslužitelja nije bilo moguće obraditi. Pokušaj kasnije.';
  ...
  @override
  String get sailDirection => 'Kurs prema vjetru';

  @override
  String get pointOfSailCloseHauled => 'Oštra orca';

  @override
  String get pointOfSailCloseReach => 'Otvorena orca';

  @override
  String get pointOfSailBeamReach => 'Bočni vjetar';

  @override
  String get pointOfSailBroadReach => 'Krmeni bok';

  @override
  String get pointOfSailRunning => 'Niz vjetar';

  @override
  String get tackPort => 'Lijevi bok';
  ...
  @override
  String get radarRefresh => 'Osvježi snimku';

  @override
  String get radarUnavailable =>
      'Radarsku snimku nije moguće učitati. Pokušaj ponovno kad budeš imao signal.';
  ...
  @override
  String get helmsmanLabel => 'Kormilar';
  ...
  @override
  String get quickNoteHint => 'Što se upravo dogodilo';

  @override
  String get pickVoyageAction => 'Odaberi plovidbu';
  ...
  @override
  String get exportCharterTitle => 'Izvoz plovidbe';
  ...
  @override
  String get exportCharterBtn => 'Izvezi plovidbu';
  ...
  @override
  String get editCharter => 'Uredi plovidbu';
  ...
  String voiceScriptTitleFor(String type) {
    return 'GLASOVNI PREDLOŽAK · $type';
  }
  ...
  String get distressNoteMayday =>
      'MAYDAY: samo kod ozbiljne i neposredne opasnosti po život ili brod. Npr. „MAYDAY, MAYDAY, MAYDAY, taking on water, sinking” (primamo vodu, tonemo).';

  @override
  String get distressNotePanPan =>
      'PAN PAN: hitna poruka koja izravno ne ugrožava život. Npr. „PAN PAN, PAN PAN, PAN PAN, engine failure, drifting toward rocks” (kvar motora, nosi nas prema stijenama).';

  @override
  String get distressNoteSecurite =>
      'SÉCURITÉ: sigurnosna poruka o plovidbi ili vremenu za ostale brodove. Npr. „SÉCURITÉ, SÉCURITÉ, SÉCURITÉ, uncharted wreck reported at position…” (prijavljena neubilježena olupina na poziciji…).';
  ...
  String get guideMilesBody =>
      'Sažetak svih vaših plovidbi na jednom mjestu (ikona u kartici Dnevnik).\n\n• Ukupno nautičkih milja, dana na moru, broj plovidbi i noćni sati\n• Raščlamba po godini i po plovilu\n• Filtar po godini\n• Dodirnite plovidbu (uključujući praćenu/uvezenu) da ispunite njezin zapis u dnevniku – ruta, zastava plovila, ime i ovlaštenje zapovjednika, potpis kojim se potvrđuju milje\n• Tipka + – dodajte prošlu plovidbu od prije nego što ste počeli koristiti aplikaciju (u potpunosti se uračunava u sažetke, u popisu je označena zvjezdicom)\n• PDF izvoz potvrde o preplovljenim miljama s mjestom za potpis\n• Potvrda o miljama izdaje se kroz obrazac (ikona PDF gore): za sebe ili za člana posade, s imenom primatelja, imenom i kvalifikacijom izdavatelja (popunjeno iz profila skipera) i popisom plovidbi s kvačicama. Dokument nosi brod, zapovjednika plovidbe, područje, plimne ili neplimne vode i funkciju u kojoj si plovio, uz razradu milja po funkciji. Za plovidbe u kojima nisi bio zapovjednik ostaje crta za njegov potpis s imenom. Potvrda za sebe nosi i skiperski sažetak. Sprema se i u mapu aplikacije, ne samo kroz sustavni dijalog.\n• Potvrda nosi i rutu plovidbe po danima — Biograd – Žut – Veli Rat – Zadar – Biograd — složenu od luka pojedinih dana; ista postaja dvaput zaredom spaja se, a dan bez upisane luke preskače.\n• U obrascu potvrde polje „Za koga\" nudi posadu s tvojih plovidbi — ime odaberi umjesto da ga tipkaš, jer bi tipfeler od jedne osobe napravio dvije.\n• Broj putovnice/osobne upisuje se pri izdavanju potvrde, za svakog člana posade posebno. Ne sprema se, ispisuje se samo na toj jednoj potvrdi; skiperov vlastiti broj stoji u kartici plovidbe i sam se popuni. Bez broja ostaje na potvrdi crta za upis rukom.\n• Potvrda se prije izdavanja potpisuje kao i dnevnik: otvara se površina za potpis, a PDF dobiva završnu stranicu s potpisom, vremenom, SHA-256 kontrolnim zbrojem i QR kodom za provjeru.';
  ...
  String get guideCompassBody =>
      'Kartica Kompas prikazuje magnetski azimut pomoću senzora telefona, sa stražnjom kamerom kao pozadinom za uzimanje azimuta na objekte.\n\n• Žuti nišan – smjer u koji ciljate\n• Traka kompasa na vrhu – S / SI / I / JI / J / JZ / Z / SZ\n• Brojčani prikaz – stupnjevi i strana svijeta\n• Zelena točka = stabilno očitanje  ·  Narančasta točka = kalibracija\n\nAko je očitanje nestabilno, polako pomičite telefon u obliku osmice da kalibrirate magnetometar.\n\nTočnost može biti smanjena u blizini metalnih konstrukcija, zvučnika ili elektroničke opreme.\n\nKompas rješava dva različita zadatka — pronaći SEBE kad ne znaš gdje si, ili odrediti NEPOZNATU TOČKU kad želiš na kartu unijeti nešto čega tamo još nema. Prekidač iznad tipke Izmjeri azimut bira koji od njih upravo radiš.\n\nMOJA POZICIJA — pronađi sebe (GPS nije potreban)\n\n1. Provjeri na karti poznaješ li barem dvije vidljive točke (svjetionik, vrh, crkvu) spremljene kao waypointi. Točku koja nedostaje dodaješ dugim pritiskom na kartu točno na njezinu poziciju.\n2. Na kompasu prebaci na \"Moja pozicija\".\n3. Dodirni oznaku ispod prekidača i odaberi prvu točku koju mjeriš.\n4. Usmjeri nišan točno na nju i pritisni Izmjeri azimut.\n5. U dijalogu provjeri izmjereni azimut i pritisni Spremi (Odustani odbacuje nacrt bez spremanja).\n6. Odaberi drugu, DRUGU točku (izbor se sam isprazni nakon spremanja) i ponovi.\n7. Na karti ćeš vidjeti dvije isprekidane linije od točaka prema tebi. Njihovo sjecište je tvoja pozicija — zeleni križić znači dobar rez, narančasti oštar kut i nesigurnu poziciju.\n8. Treća točka, najbolje pod drugim kutom, precizira procjenu i crta trokut pogreške.\n\nNapravi to brzo, unutar 5 minuta — presjek pretpostavlja da brod između mjerenja stoji.\n\nNEPOZNATA TOČKA — odredi objekt (GPS je potreban)\n\n1. Prebaci na \"Nepoznata točka\".\n2. Dodirni oznaku, odaberi \"Nova točka…\" i nazovi ono što mjeriš, npr. \"nepoznata hrid\".\n3. Nišani, Izmjeri azimut, potvrdi Spremi.\n4. Pomakni brod barem nekoliko stotina metara — što dalje, to pouzdaniji rezultat.\n5. Ponovno otvori odabir cilja, odaberi ISTI objekt s popisa (ne \"Nova točka\") i izmjeri drugi put.\n6. Na karti se pojavljuje oznaka s izračunatom pozicijom objekta. Dodirom je spremaš kao waypoint — od tog trenutka se može koristiti i za presjek.\n\nTočnost\n\nKompas u telefonu ima stvarnu pogrešku od oko ±8°, što je na 10 NM više od 2,5 NM bočnog odstupanja — upravo zato aplikacija crta stožac nesigurnosti umjesto tanke linije. Najbolji rez daju točke pod kutom blizu 90°; kad su gotovo u istoj liniji s tobom, sjecište se rasplinjava na stotine metara ili više.\n\nAzimuti bez plovidbe\n\nAzimut se sprema i bez uključenog trackinga — na sidru, na kopnu. Naći ćeš ga u popisu plovidbi kao poseban redak s datumom, između pojedinih plovidbi. Otvaranjem prikazuješ azimute tog dana s malom kartom, i odande pokrećeš izvoz jednostavnog PDF-a s kartom i tablicom azimuta.\n\nČišćenje karte i brisanje azimuta\n\nMjerenje na čistoj karti – na Kompasu ikona osvježavanja gore desno. Sklanja postojeće azimute s karte i poništava odabranu točku ili objekt, pa sljedeće Izmjeri azimut kreće ispočetka. Ništa se ne gubi: zapisi ostaju u kartici Brodski dnevnik i u PDF izvozu.\n\nTrajno brisanje – otvori redak s datumom u popisu plovidbi. Križić uz redak briše jedan azimut (kod objekta cijeli niz mjerenja na njega). Kanta u gornjoj traci briše cijeli dan odjednom i vraća te natrag na popis. Brisanje je nepovratno i ti azimuti nestaju i iz PDF izvoza.\n\nUkratko: čišćenje pospremi kartu, brisanje uklanja zapis. Sadržaj PDF-a mijenja jedino brisanje.';
  ...
  @override
  String get vesselPickSaved => 'Odaberi jedan od mojih brodova';

  @override
  String get vesselOwnLabel => 'Vlastiti brod';

  @override
  String get vesselOwnHint =>
      'Sprema se na vrh popisa brodova, da se sljedeća plovidba sama popuni.';

  @override
  String get vesselNoneSaved =>
      'Još nema spremljenog broda — spremi se pri spremanju plovidbe.';
  ...
  @override
  String get checklistAddOwnItem => 'Dodaj vlastitu stavku';
  ...
  @override
  String get charterPriceLabel => 'Cijena plovidbe';
  ...
  @override
  String get costBaseCharter => 'Osnovna cijena plovidbe';
  ...
  @override
  String get syncLogbookEnableToggle => 'Sinkroniziraj dnevnik između uređaja';

  @override
  String get syncLogbookEnableToggleDesc =>
      'Novi unosi, dani i plovidbe kontinuirano se šalju i preuzimaju putem istog Google računa — za više vlastitih telefona na istom brodu.';
  ...
  @override
  String get dateFormatLabel => 'Format datuma';

  @override
  String get dateFormatByLanguage => 'Prema jeziku aplikacije';
  ...
  @override
  String get crewCertRoute => 'Ruta plovidbe';
  ...
  String get crewCertIdNotStored =>
      'Broj se ne sprema — ispisuje se samo na ovoj potvrdi.';
  ...
  @override
  String get bearingTakeSight => 'Izmjeri azimut';

  @override
  String bearingSaved(String bearing) {
    return 'Azimut $bearing spremljen';
  }

  @override
  String get bearingNoPosition =>
      'Bez GPS-a nepoznatu točku nije moguće određivati. Prebaci na „Moja pozicija“ — presjek poznatih točaka ne traži GPS.';

  @override
  String get bearingSaveFailed => 'Azimut nije spremljen';

  @override
  String get bearingLabelHint => 'Što mjeriš? (nije obavezno)';
  ...
  String get bearingDeclinationExpired =>
      'Magnetski model je istekao — deklinacija je samo procjena';
  ...
  String get bearingsEmpty =>
      'Još nema azimuta. Usmjeri telefon na objekt i pritisni Izmjeri azimut.';

  @override
  String get bearingsDeleteDayConfirm =>
      'Svi azimuti tog dana trajno će se obrisati, i iz PDF izvoza. Ovaj se korak ne može poništiti.';

  @override
  String bearingFixFrom(int count) {
    return 'Pozicija iz $count azimuta';
  }

  @override
  String bearingFixWeak(String angle) {
    return 'Slab presjek — linije se sijeku pod samo $angle';
  }

  @override
  String bearingFixOffGps(String distance) {
    return 'Odstupanje od GPS-a: $distance';
  }
  ...
  @override
  String get bearingMagneticLabel => 'magnetski';

  @override
  String bearingUncertaintyNote(String deg) {
    return 'Stožac prikazuje ±$deg nesigurnost kompasa u telefonu.';
  }
  ...
  @override
  String get bearingModeResection => 'Moja pozicija';

  @override
  String get bearingModeObject => 'Nepoznata točka';

  @override
  String get bearingModeResectionHint =>
      'Izmjeri azimut na 2–3 poznate točke s karte. GPS nije potreban.';

  @override
  String get bearingModeObjectHint =>
      'Izmjeri istu točku s 2–3 različita mjesta. Potreban je GPS.';

  @override
  String get bearingPickTarget => 'Odaberi točku za mjerenje';

  @override
  String get bearingNeedsTarget =>
      'Najprije odaberi poznatu točku s karte, zatim izmjeri';

  @override
  String get bearingNeedsObject => 'Najprije nazovi točku koju mjeriš';

  @override
  String get bearingNewObject => 'Nova točka…';

  @override
  String get bearingObjectName => 'Naziv točke (npr. nepoznata hrid)';

  @override
  String get bearingOpenObjects => 'Točke u određivanju';

  @override
  String bearingSightCount(int count) {
    return '$count azimuta';
  }

  @override
  String get bearingSameTargetHint =>
      'Ista točka kao prije — za presjek treba druga.';

  @override
  String get bearingShortBaselineHint =>
      'Kratka baza — pomakni se i izmjeri ponovno.';

  @override
  String get bearingMovedHint =>
      'Brod se pomaknuo između mjerenja — presjek pretpostavlja da stoji.';

  @override
  String get bearingNeedsSecondSight =>
      'Još jedan azimut na drugu točku i pozicija će izaći.';

  @override
  String get bearingMyPositionFix => 'Moja pozicija';

  @override
  String get bearingObjectFix => 'Određena točka';

  @override
  String get bearingSaveObjectAsWaypoint => 'Spremi kao waypoint';

  @override
  String bearingObjectSaved(String name) {
    return '$name spremljen kao waypoint';
  }

  @override
  String get bearingDeclinationFromTarget =>
      'Deklinacija računana u poziciji izmjerene točke';

  @override
  String get bearingResectionSection => 'Presjek — pozicija iz poznatih točaka';

  @override
  String get bearingObjectSection => 'Određivanje nepoznatih točaka';

  @override
  String get bearingPdfMark => 'Izmjerena točka';
  ...
  String anchorQuickStarted(String radius) {
    return 'Sidrena straža radi · $radius m';
  }

  @override
  String get anchorQuickStopTitle => 'Zaustaviti sidrenu stražu?';

  @override
  String get anchorQuickStopBody =>
      'Straža prestaje, a u dnevnik ide „Sidro podignuto\".';

  @override
  String get mobCancelTitle => 'Otkazati MOB?';

  @override
  String get mobCancelBody => 'Alarm prestaje i točka pada više se ne prati.';

  @override
  String get anchorSoundLabel => 'Zvuk alarma';

  @override
  String get anchorVolumeLabel => 'Glasnoća alarma';

  @override
  String get anchorSoundPreview => 'Pusti primjer';

  @override
  String get anchorSoundPreviewDesc =>
      'Zvuk koji nikad nisi čuo neće u tri ujutro značiti „sidro\".';

  @override
  String anchorWatchDaySummary(String range, String points, String swing) {
    return 'Sidrena straža $range · $points točaka · najveći zaokret $swing m';
  }

  @override
  String get anchorSoundSystemDefault => 'Zvuk budilice telefona';

  @override
  String get anchorVolumeDesc =>
      'Ovo je stvarna glasnoća, ne množitelj: dok alarm traje, aplikacija podiže alarmni kanal telefona na ovu razinu i poslije ga vraća natrag.';

  @override
  String get anchorDndTitle => 'Način Ne uznemiravaj nadjačava glasnoću';

  @override
  String get anchorDndBody =>
      'Dok je Ne uznemiravaj uključen, samo ti možeš dopustiti podizanje glasnoće. Bez toga alarm će se ipak oglasiti, ali onoliko glasno koliko je telefon namješten.';

  @override
  String get unassignedMobTitle => 'MOB izvan plovidbe';

  @override
  String get unassignedAnchorTitle => 'Sidro izvan plovidbe';

  @override
  String get unassignedEventTitle => 'Događaj izvan plovidbe';

  @override
  String get logEventMobCancelled => 'MOB otkazan';
}
