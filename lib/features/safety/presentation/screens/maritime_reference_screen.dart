...
const _alphabet = [
  (letter: 'A', nato: 'Alpha',    morse: '·−',
    ...
    flagDescCs: 'Potápěč pod hladinou – nepřibližujte se', flagDescPl: 'Nurek pod wodą – zachowaj odstęp', flagDescEl: 'Δύτης στο νερό – κρατηθείτε μακριά', flagDescHr: 'Ronilac u vodi – držite se podalje', flagDescSl: 'Potapljač v vodi – držite se stran', flagDescIt: 'Ho un palombaro in immersione – tenersi a distanza'),
  (letter: 'B', nato: 'Bravo',    morse: '−···',
    ...
    flagDescCs: 'Nebezpečný náklad na palubě', flagDescPl: 'Niebezpieczny ładunek na pokładzie', flagDescEl: 'Επικίνδυνο φορτίο στο σκάφος', flagDescHr: 'Opasan teret na brodu', flagDescSl: 'Nevaren tovor na krovu', flagDescIt: 'Merci pericolose a bordo'),
  (letter: 'C', nato: 'Charlie',  morse: '−·−·',
    ...
    flagDescCs: 'Ano / Souhlasím', flagDescPl: 'Tak / Potwierdzam', flagDescEl: 'Ναι / Καταφατικό', flagDescHr: 'Da / Potvrdno', flagDescSl: 'Da / Pritrdilno', flagDescIt: 'Sì / Affermativo'),
  (letter: 'D', nato: 'Delta',    morse: '−··',
    ...
    flagDescCs: 'Držte se dál – obtížně manévruji', flagDescPl: 'Zachowaj odstęp – manewruję z trudnością', flagDescEl: 'Κρατηθείτε μακριά – ελίσσομαι με δυσκολία', flagDescHr: 'Držite se podalje – teško manevriram', flagDescSl: 'Držite se stran – težko manevriram', flagDescIt: 'Tenersi a distanza – manovro con difficoltà'),
  (letter: 'E', nato: 'Echo',     morse: '·',
    ...
    flagDescCs: 'Měním kurz doprava', flagDescPl: 'Zmieniam kurs w prawo', flagDescEl: 'Αλλάζω πορεία δεξιά', flagDescHr: 'Mijenjam kurs udesno', flagDescSl: 'Spreminjam kurz v desno', flagDescIt: 'Accosto a dritta'),
  (letter: 'F', nato: 'Foxtrot',  morse: '··−·',
    ...
    flagDescCs: 'Jsem neschopný manévru – kontaktujte mě', flagDescPl: 'Jestem niezdolny do manewru – skontaktuj się ze mną', flagDescEl: 'Είμαι ακυβέρνητος – επικοινωνήστε μαζί μου', flagDescHr: 'Onesposobljen sam – stupite u vezu sa mnom', flagDescSl: 'Nesposoben za manevriranje – vzpostavite stik z mano', flagDescIt: 'Sono in avaria – comunicate con me'),
  (letter: 'G', nato: 'Golf',     morse: '−−·',
    ...
    flagDescCs: 'Potřebuji lodivoda', flagDescPl: 'Potrzebuję pilota', flagDescEl: 'Χρειάζομαι πλοηγό', flagDescHr: 'Trebam peljara', flagDescSl: 'Potrebujem pilota', flagDescIt: 'Richiedo un pilota'),
  (letter: 'H', nato: 'Hotel',    morse: '····',
    ...
    flagDescCs: 'Lodivod na palubě', flagDescPl: 'Pilot na pokładzie', flagDescEl: 'Πλοηγός στο σκάφος', flagDescHr: 'Peljar je na brodu', flagDescSl: 'Pilot je na krovu', flagDescIt: 'Ho il pilota a bordo'),
  (letter: 'I', nato: 'India',    morse: '··',
    ...
    flagDescCs: 'Měním kurz doleva', flagDescPl: 'Zmieniam kurs w lewo', flagDescEl: 'Αλλάζω πορεία αριστερά', flagDescHr: 'Mijenjam kurs ulijevo', flagDescSl: 'Spreminjam kurz v levo', flagDescIt: 'Accosto a sinistra'),
  (letter: 'J', nato: 'Juliet',   morse: '·−−−',
    ...
    flagDescCs: 'Požár a nebezpečný náklad – držte se dál', flagDescPl: 'Pożar i niebezpieczny ładunek – zachowaj odstęp', flagDescEl: 'Φωτιά και επικίνδυνο φορτίο – κρατηθείτε μακριά', flagDescHr: 'Požar i opasan teret – držite se podalje', flagDescSl: 'Požar in nevaren tovor – držite se stran', flagDescIt: 'Incendio e carico pericoloso – tenersi a distanza'),
  (letter: 'K', nato: 'Kilo',     morse: '−·−',
    ...
    flagDescCs: 'Chci komunikovat', flagDescPl: 'Chcę się porozumieć', flagDescEl: 'Θέλω να επικοινωνήσω', flagDescHr: 'Želim stupiti u vezu', flagDescSl: 'Želim vzpostaviti stik', flagDescIt: 'Desidero comunicare con voi'),
  (letter: 'L', nato: 'Lima',     morse: '·−··',
    ...
    flagDescCs: 'Okamžitě zastavte své plavidlo', flagDescPl: 'Natychmiast zatrzymaj swoją jednostkę', flagDescEl: 'Σταματήστε αμέσως το σκάφος σας', flagDescHr: 'Odmah zaustavite plovilo', flagDescSl: 'Takoj ustavite plovilo', flagDescIt: 'Fermate immediatamente la vostra nave'),
  (letter: 'M', nato: 'Mike',     morse: '−−',
    ...
    flagDescCs: 'Moje plavidlo stojí', flagDescPl: 'Moja jednostka stoi', flagDescEl: 'Το σκάφος μου είναι σταματημένο', flagDescHr: 'Moje plovilo je zaustavljeno', flagDescSl: 'Moje plovilo je ustavljeno', flagDescIt: 'La mia nave è ferma'),
  (letter: 'N', nato: 'November', morse: '−·',
    flagDescEn: 'No / Negative',                         flagDescSk: 'Nie / Nesúhlasím',
    flagDescDe: 'Nein / Negativ',                        flagDescEs: 'No / Negativo',
    flagDescUk: 'Ні / Негативно',
    flagDescCs: 'Ne / Nesouhlasím', flagDescPl: 'Nie / Przeczę', flagDescEl: 'Όχι / Αρνητικό', flagDescHr: 'Ne / Niječno', flagDescSl: 'Ne / Nikalno', flagDescIt: 'No / Negativo'),
  (letter: 'O', nato: 'Oscar',    morse: '−−−',
    ...
    flagDescCs: 'Muž přes palubu', flagDescPl: 'Człowiek za burtą', flagDescEl: 'Άνθρωπος στη θάλασσα', flagDescHr: 'Čovjek u moru', flagDescSl: 'Človek v morju', flagDescIt: 'Uomo in mare'),
  (letter: 'P', nato: 'Papa',     morse: '·−−·',
    ...
    flagDescCs: 'Všichni na palubu – vyplouvám na moře', flagDescPl: 'Wszyscy na pokład – wypływam w morze', flagDescEl: 'Όλοι στο σκάφος – αποπλέω', flagDescHr: 'Svi na brod – isplovljavamo', flagDescSl: 'Vsi na krov – izplutje', flagDescIt: 'Tutti a bordo – la nave sta per salpare'),
  (letter: 'Q', nato: 'Quebec',   morse: '−−·−',
    ...
    flagDescCs: 'Loď je zdravá – žádám volný přístup', flagDescPl: 'Statek zdrowy – proszę o wolną praktykę', flagDescEl: 'Το πλοίο είναι υγιές – ζητώ ελεύθερη πρατίκα', flagDescHr: 'Brod je zdrav – tražim slobodan promet', flagDescSl: 'Ladja je zdrava – prosim za prost promet', flagDescIt: 'La nave è sana – richiedo libera pratica'),
  (letter: 'R', nato: 'Romeo',    morse: '·−·',
    ...
    flagDescCs: '(Bez standardního významu ICS)', flagDescPl: '(Bez standardowego znaczenia ICS)', flagDescEl: '(Χωρίς τυπική σημασία ICS)', flagDescHr: '(Nema standardnog ICS značenja)', flagDescSl: '(Ni standardnega pomena ICS)', flagDescIt: '(Nessun significato standard ICS)'),
  (letter: 'S', nato: 'Sierra',   morse: '···',
    ...
    flagDescCs: 'Motory plnou vzad', flagDescPl: 'Maszyny cała wstecz', flagDescEl: 'Μηχανές ολοταχώς ανάποδα', flagDescHr: 'Strojevi punom snagom krmom', flagDescSl: 'Stroji s polno močjo nazaj', flagDescIt: 'Macchine indietro tutta'),
  (letter: 'T', nato: 'Tango',    morse: '−',
    ...
    flagDescCs: 'Lovím v páru vlečnou sítí – držte se dál', flagDescPl: 'Prowadzę połów tuką parą – zachowaj odstęp', flagDescEl: 'Ψαρεύω με ζευγαρωτή τράτα – κρατηθείτε μακριά', flagDescHr: 'Bavim se koćarenjem u paru – držite se podalje', flagDescSl: 'Opravljam parno vlečno ribolov – držite se stran', flagDescIt: 'Sto pescando a coppie – tenersi a distanza'),
  (letter: 'U', nato: 'Uniform',  morse: '··−',
    ...
    flagDescCs: 'Míříte do nebezpečí', flagDescPl: 'Zmierzasz ku niebezpieczeństwu', flagDescEl: 'Οδεύετε προς κίνδυνο', flagDescHr: 'Plovite u opasnost', flagDescSl: 'Plujete v nevarnost', flagDescIt: 'State dirigendo verso un pericolo'),
  (letter: 'V', nato: 'Victor',   morse: '···−',
    ...
    flagDescCs: 'Potřebuji pomoc', flagDescPl: 'Potrzebuję pomocy', flagDescEl: 'Χρειάζομαι βοήθεια', flagDescHr: 'Trebam pomoć', flagDescSl: 'Potrebujem pomoč', flagDescIt: 'Richiedo assistenza'),
  (letter: 'W', nato: 'Whiskey',  morse: '·−−',
    ...
    flagDescCs: 'Potřebuji lékařskou pomoc', flagDescPl: 'Potrzebuję pomocy medycznej', flagDescEl: 'Χρειάζομαι ιατρική βοήθεια', flagDescHr: 'Trebam liječničku pomoć', flagDescSl: 'Potrebujem zdravniško pomoč', flagDescIt: 'Richiedo assistenza medica'),
  (letter: 'X', nato: 'X-ray',    morse: '−··−',
    ...
    flagDescCs: 'Zastavte – sledujte mé signály', flagDescPl: 'Zatrzymaj się – obserwuj moje sygnały', flagDescEl: 'Σταματήστε – προσέξτε τα σήματά μου', flagDescHr: 'Stanite – pratite moje signale', flagDescSl: 'Ustavite – spremljajte moje signale', flagDescIt: 'Sospendete – attendete i miei segnali'),
  (letter: 'Y', nato: 'Yankee',   morse: '−·−−',
    ...
    flagDescCs: 'Vleču kotvu', flagDescPl: 'Kotwica pełznie', flagDescEl: 'Σέρνω άγκυρα', flagDescHr: 'Sidro ore', flagDescSl: 'Sidro orje', flagDescIt: 'Sto arando l\'ancora'),
  (letter: 'Z', nato: 'Zulu',     morse: '−−··',
    ...
    flagDescCs: 'Potřebuji remorkér', flagDescPl: 'Potrzebuję holownika', flagDescEl: 'Χρειάζομαι ρυμουλκό', flagDescHr: 'Trebam tegljač', flagDescSl: 'Potrebujem vlačilec', flagDescIt: 'Richiedo un rimorchiatore'),
];
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: Padding(
            ...
            child: Row(children: [
              CodeFlagView(letter: entry.letter),
...
const _dayShapes = [
  (
    ...
    titleEs: 'Bola negra (esfera)', titleUk: 'Чорна куля', titleCs: 'Černý balón',
    titlePl: 'Czarna kula', titleEl: 'Μαύρη μπάλα (σφαίρα)', titleHr: 'Crna kugla', titleSl: 'Črna krogla', titleIt: 'Pallone nero',
    ...
    descIt: 'Nave alla fonda.\nPallone esposto a prua.',
  ),
  (
    shape: 'ball-ball',
    rule: 'Rule 27(a)',
    titleEn: 'Two balls vertical', titleSk: 'Dve gule zvisle', titleDe: 'Zwei Bälle senkrecht',
    titleEs: 'Dos bolas verticales', titleUk: 'Дві кулі вертикально', titleCs: 'Dva balóny svisle',
    titlePl: 'Dwie kule pionowo', titleEl: 'Δύο μπάλες κατακόρυφα', titleHr: 'Dvije kugle okomito', titleSl: 'Dve krogli navpično', titleIt: 'Due palloni in verticale',
    ...
    descIt: 'Nave non governabile (NUC).\nIncapace di manovrare per circostanze eccezionali.',
  ),
  (
    shape: 'ball-diamond-ball',
    rule: 'Rule 27(b)',
    titleEn: 'Ball – Diamond – Ball', titleSk: 'Guľa – kosoštvorec – guľa', titleDe: 'Ball – Rhombus – Ball',
    titleEs: 'Bola – rombo – bola', titleUk: 'Куля – ромб – куля', titleCs: 'Balón – kosočtverec – balón',
    titlePl: 'Kula – romb – kula', titleEl: 'Μπάλα – ρόμβος – μπάλα', titleHr: 'Kugla – romb – kugla', titleSl: 'Krogla – romb – krogla', titleIt: 'Pallone - bicono - pallone',
    descEn: 'Vessel restricted in her ability to manoeuvre.\nDredging, cable laying or underwater work.',
    descSk: 'Loď s obmedzenou schopnosťou manévrovať.\nBagrovanie, kladenie káblov alebo podvodné práce.',
    descDe: 'Manövrierbehindertes Fahrzeug.\nBaggern, Kabelarbeiten oder Unterwasserarbeiten.',
    descEs: 'Buque con capacidad de maniobra restringida.\nDragado, tendido de cables o trabajos submarinos.',
    descUk: 'Судно, обмежене в можливості маневрувати.\nДнопоглиблення, прокладання кабелю або підводні роботи.',
    descCs: 'Loď s omezenou schopností manévrovat.\nBagrování, pokládka kabelů nebo podvodní práce.',
    descPl: 'Jednostka o ograniczonej zdolności manewrowej.\nPogłębianie, układanie kabli lub prace podwodne.',
    descEl: 'Σκάφος περιορισμένης ικανότητας ελιγμών.\nΒυθοκόρηση, πόντιση καλωδίων ή υποβρύχιες εργασίες.',
    descHr: 'Plovilo ograničene sposobnosti manevriranja.\nJaružanje, polaganje kabela ili podvodni radovi.',
    descSl: 'Plovilo z omejeno sposobnostjo manevriranja.\nPoglabljanje, polaganje kablov ali podvodna dela.',
    descIt: 'Nave con manovrabilità limitata.\nDragaggio, posa di cavi o lavori subacquei.',
  ),
  (
    shape: 'diamond',
    rule: 'Rule 24',
    ...
    titlePl: 'Romb', titleEl: 'Ρόμβος', titleHr: 'Romb', titleSl: 'Romb', titleIt: 'Bicono',
    ...
    descIt: 'Rimorchio di lunghezza superiore a 200 m.\nEsposto sia dal rimorchiatore sia dal rimorchiato.',
  ),
  (
    shape: 'cone-down',
    rule: 'Rule 25',
    ...
    titlePl: 'Stożek wierzchołkiem w dół', titleEl: 'Κώνος με κορυφή προς τα κάτω', titleHr: 'Stožac vrhom prema dolje', titleSl: 'Stožec z vrhom navzdol', titleIt: 'Cono con il vertice in basso',
    ...
    descIt: 'Nave a vela che utilizza anche il motore.\nDeve esporre un cono con il vertice rivolto verso il basso.',
  ),
  (
    shape: 'cones-apexes',
    rule: 'Rule 26',
    ...
    titlePl: 'Dwa stożki wierzchołkami do siebie', titleEl: 'Δύο κώνοι με κορυφές μαζί', titleHr: 'Dva stošca spojena vrhovima', titleSl: 'Dva stožca, spojena z vrhovoma', titleIt: 'Due coni uniti per i vertici',
    descEn: 'Vessel engaged in fishing - trawling or any other gear.\nGear extending more than 150 m: one more cone, apex up, pointing that way.',
    descSk: 'Loď zaneprázdnená rybolovom - vlečnou sieťou aj iným výstrojom.\nVýstroj presahujúci 150 m: navyše kužeľ hrotom nahor v jeho smere.',
    descDe: 'Fischereifahrzeug beim Fischfang - Schleppnetz oder anderes Geschirr.\nGeschirr über 150 m: zusätzlicher Kegel, Spitze nach oben, in dessen Richtung.',
    descEs: 'Buque dedicado a la pesca - arrastre u otros artes.\nArtes de más de 150 m: un cono más, vértice arriba, en su dirección.',
    descUk: 'Судно, зайняте ловом риби - трал або інша снасть.\nСнасть понад 150 м: ще один конус вершиною вгору в її напрямку.',
    descCs: 'Loď zaneprázdněná rybolovem - vlečnou sítí i jiným zařízením.\nZařízení přesahující 150 m: navíc kužel hrotem nahoru v jeho směru.',
    descPl: 'Jednostka zajęta połowem - włok lub inne narzędzia.\nNarzędzia dłuższe niż 150 m: dodatkowy stożek wierzchołkiem w górę w ich kierunku.',
    descEl: 'Σκάφος που αλιεύει - με τράτα ή άλλα εργαλεία.\nΕργαλεία πάνω από 150 m: ένας ακόμη κώνος με κορυφή προς τα πάνω προς την κατεύθυνσή τους.',
    descHr: 'Plovilo u ribolovu - koćom ili drugim alatom.\nAlat duži od 150 m: još jedan stožac vrhom prema gore u njegovu smjeru.',
    descSl: 'Plovilo pri ribolovu - z vlečno mrežo ali drugim orodjem.\nOrodje, daljše od 150 m: še en stožec z vrhom navzgor v njegovo smer.',
    descIt: 'Nave impegnata nella pesca - traino o altri attrezzi.\nAttrezzi oltre 150 m: un altro cono, vertice in alto, nella loro direzione.',
  ),
  (
    shape: 'cylinder',
    rule: 'Rule 28',
    ...
    titlePl: 'Walec', titleEl: 'Κύλινδρος', titleHr: 'Valjak', titleSl: 'Valj', titleIt: 'Cilindro',
    descEn: 'Vessel constrained by her draught.\nDepth keeps her in the channel - she cannot give way.',
    descSk: 'Loď obmedzená svojím ponorom.\nHĺbka ju drží v kanáli - nemôže uhnúť.',
    descDe: 'Durch Tiefgang behindertes Fahrzeug.\nDie Wassertiefe hält es im Fahrwasser - es kann nicht ausweichen.',
    descEs: 'Buque restringido por su calado.\nLa profundidad lo obliga a seguir el canal - no puede ceder el paso.',
    descUk: 'Судно, обмежене своєю осадкою.\nГлибина утримує його у фарватері - воно не може поступитися дорогою.',
    descCs: 'Loď omezená svým ponorem.\nHloubka ji drží v kanálu - nemůže uhnout.',
    descPl: 'Jednostka ograniczona swoim zanurzeniem.\nGłębokość utrzymuje ją w torze wodnym - nie może ustąpić drogi.',
    descEl: 'Σκάφος περιορισμένο από το βύθισμά του.\nΤο βάθος το κρατά στον δίαυλο - δεν μπορεί να παραχωρήσει πορεία.',
    descHr: 'Plovilo ograničeno svojim gazom.\nDubina ga drži u kanalu - ne može ustupiti put.',
    descSl: 'Plovilo, omejeno s svojim ugrezom.\nGlobina ga drži v kanalu - ne more se umakniti.',
    descIt: 'Nave condizionata dalla propria immersione.\nIl fondale la obbliga a seguire il canale - non può dare la precedenza.',
  ),
  (
    shape: 'ball-ball-ball',
    rule: 'Rule 30(d)',
    titleEn: 'Three balls vertical', titleSk: 'Tri gule zvisle', titleDe: 'Drei Bälle senkrecht',
    titleEs: 'Tres bolas verticales', titleUk: 'Три кулі вертикально', titleCs: 'Tři balóny svisle',
    titlePl: 'Trzy kule pionowo', titleEl: 'Τρεις μπάλες κατακόρυφα', titleHr: 'Tri kugle okomito', titleSl: 'Tri krogle navpično', titleIt: 'Tre palloni in verticale',
    ...
    descCs: 'Loď na mělčině. Tři balóny vyvěšené svisle.',
    ...
    descIt: 'Nave incagliata. Tre palloni esposti in linea verticale.',
  ),
];
...
String _dayShapeTitle(dynamic s, String lc) => switch (lc) {
      ...
      'hr' => s.titleHr, 'sl' => s.titleSl, 'it' => s.titleIt,
      _ => s.titleEn,
    } as String;
...
String _dayShapeDesc(dynamic s, String lc) => switch (lc) {
      ...
      'hr' => s.descHr, 'sl' => s.descSl, 'it' => s.descIt,
      _ => s.descEn,
    } as String;
