...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get userGuide => 'Довідник';

  @override
  String get guideQuickStart => 'Швидкий старт';

  @override
  String get guideQuickStartBody =>
      'Перед кожним рейсом:\n'
      '1. Перевірте прогноз погоди\n'
      '2. Проведіть інструктаж з безпеки з екіпажем\n'
      '3. Пройдіть список Check-in\n'
      '4. Заповніть ідентифікацію судна в Налаштуваннях\n'
      '5. Журнал → + → Запустити відстеження\n'
      '6. Попутного вітру!';
  ...
  String get guideMapBody =>
      'Показує поточну GPS-позицію та маршрут рейсу.\n\n'
      'Можна додавати вейпоінти – точки інтересу, такі як порти або місця якорування. '
      'Натисніть на панель VMG WP в Приладах, щоб вибрати активний вейпоінт.';

  @override
  String get guideInstrTitle => 'Прилади (Instruments)';

  @override
  String get guideInstrBody =>
      'Цифрова навігаційна панель із даними в реальному часі:\n\n'
      '• SOG – швидкість судна у вузлах (1 вузол = 1,85 км/год)\n'
      '• TWS – істинна швидкість вітру\n'
      '• TWA – кут вітру (зелений = правий борт, червоний = лівий борт)\n'
      '• DEPTH – глибина води; червоний сигнал менше 5 м\n'
      '• VMG WP – швидкість наближення до вейпоінта\n\n'
      'Великий компас показує курс і напрямок вітру. Значок у правому верхньому куті '
      'показує, чи дані надходять з GPS телефону або з Raymarine.';

  @override
  String get guideLogbookTitle => 'Журнал і початок рейсу';

  @override
  String get guideLogbookBody =>
      'Журнал зберігає всі записи. Рейс запускається натисканням + у правому нижньому куті.\n\n'
      'Типи рейсу:\n'
      '• Багатоденний – чартер на кілька днів, записи сортуються по днях\n'
      '• Одноденний – денна поїздка\n\n'
      'Записи створюються автоматично під час відстеження. '
      'Ручний запис додайте кнопкою «Додати вручну» – містить позицію, вітер, хвилі, мотор, нотатку і фото.\n\n'
      'Відстеження продовжується у фоні, навіть якщо ви закрили застосунок.';
  ...
  String get guideWeatherBody =>
      '3-денний прогноз для GPS-позиції з погодинною таблицею вітру, хвиль та опадів. '
      'Включає графіки вітру і хвиль та денні температури.\n\n'
      'Шкала Бофора: 0 = штиль, 6 = сильний вітер (≈50 км/год), 8–9 = шторм.\n\n'
      'При підключенні до Raymarine відображаються живі дані з корабельної електроніки.';

  @override
  String get guideSafetyMobTitle => 'МЗБ – Людина за бортом';

  @override
  String get guideSafetyMobBody =>
      'Утримуйте червону кнопку МЗБ для активації. '
      'Застосунок записує GPS-координати та показує відстань, пеленг і час. '
      'Кнопка «Навігація до МЗБ» відкриває карту.\n\n'
      'Якірна сигналізація: після якорування встановіть радіус (рекомендується 50+ м) і натисніть Активувати. '
      'Сигналізація спрацьовує, якщо судно виходить за периметр.';

  @override
  String get guideSafetyBriefingTitle => 'Інструктаж, MAYDAY та інше';

  @override
  String get guideSafetyBriefingBody =>
      'Інструктаж з безпеки – контрольний список із 12 пунктів для екіпажу перед відплиттям.\n\n'
      'Картка MAYDAY – процедура DSC та голосовий сценарій для каналу ОВЧ 16. '
      'Заповніть кількість осіб і характер лиха заздалегідь. '
      'Позивний і MMSI заповнюються автоматично з Налаштувань.\n\n'
      'Check-in / Check-out – списки при прийнятті та поверненні чартерного судна.\n\n'
      'Список спорядження – ваш особистий список речей на борт.';
  ...
  String get guideSettingsBody =>
      'Одиниці: температура (°C / °F), глибина і хвилі (м / фут), вітер (вузли / м/с / Бофор).\n\n'
      'Мова: Slovenčina, English, Deutsch, Español, Українська.\n\n'
      'Ідентифікація судна: позивний та MMSI – автоматично заповнюються в картці MAYDAY.\n\n'
      'Raymarine: IP-адреса та порт шлюзу Wi-Fi (зазвичай 10.0.0.1 : 2000). '
      'Спочатку підключіть телефон до Wi-Fi судна.\n\n'
      'Онлайн-акаунт: синхронізація журналу з logbook.hmba.boats.';

  @override
  String get guideExportTitle => 'Експорт PDF';

  @override
  String get guideExportBody =>
      'Створіть PDF-журнал із картою маршруту для будь-якого рейсу або дня.\n\n'
      'Процес: Журнал → рейс → Експортувати PDF → зачекайте генерації карт → '
      'підпишіться пальцем → Підписати та експортувати.\n\n'
      'PDF містить титульну сторінку, карти маршруту, таблиці записів і підпис шкіпера. '
      'Збережіть на пристрої або поділіться через е-пошту / WhatsApp.';
}
