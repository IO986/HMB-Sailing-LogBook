...
abstract class AppLocalizations {
  ...
  /// No description provided for @pickVoyageAction.
  ///
  /// In sk, this message translates to:
  /// **'Vybrať plavbu'**
  String get pickVoyageAction;
  ...
  /// No description provided for @vesselPickSaved.
  ///
  /// In sk, this message translates to:
  /// **'Vybrať z mojich lodí'**
  String get vesselPickSaved;

  /// No description provided for @vesselOwnLabel.
  ///
  /// In sk, this message translates to:
  /// **'Vlastná loď'**
  String get vesselOwnLabel;

  /// No description provided for @vesselOwnHint.
  ///
  /// In sk, this message translates to:
  /// **'Uloží sa do zoznamu lodí navrchu, aby sa ďalšia plavba na nej vyplnila sama.'**
  String get vesselOwnHint;

  /// No description provided for @vesselNoneSaved.
  ///
  /// In sk, this message translates to:
  /// **'Zatiaľ nemáš uloženú žiadnu loď — uloží sa sama pri uložení plavby.'**
  String get vesselNoneSaved;

  /// No description provided for @briefingAddOwnItem.
  ///
  /// In sk, this message translates to:
  /// **'Pridať vlastný bod'**
  ...
  /// In sk, this message translates to:
  /// **'Nový bod brífingu'**
  String get briefingOwnItemHint;

  /// No description provided for @checklistAddOwnItem.
  ///
  /// In sk, this message translates to:
  /// **'Pridať vlastnú položku'**
  String get checklistAddOwnItem;
