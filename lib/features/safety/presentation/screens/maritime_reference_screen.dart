...
const _alphabet = [
  (letter: 'A', nato: 'Alpha',    morse: '·−',     flagColors: [Colors.white, Colors.blue],
    ...
    flagDescCs: 'Potápěč pod hladinou – nepřibližujte se', flagDescPl: 'Nurek pod wodą – zachowaj odstęp', flagDescEl: 'Δύτης στο νερό – κρατηθείτε μακριά', flagDescHr: 'Ronilac u vodi – držite se podalje'),
  (letter: 'B', nato: 'Bravo',    morse: '−···',   flagColors: [Colors.red],
    ...
    flagDescCs: 'Nebezpečný náklad na palubě', flagDescPl: 'Niebezpieczny ładunek na pokładzie', flagDescEl: 'Επικίνδυνο φορτίο στο σκάφος', flagDescHr: 'Opasan teret na brodu'),
  (letter: 'C', nato: 'Charlie',  morse: '−·−·',   flagColors: [Colors.blue, Colors.white, Colors.red, Colors.white, Colors.blue],
    ...
    flagDescCs: 'Ano / Souhlasím', flagDescPl: 'Tak / Potwierdzam', flagDescEl: 'Ναι / Καταφατικό', flagDescHr: 'Da / Potvrdno'),
  (letter: 'D', nato: 'Delta',    morse: '−··',    flagColors: [Colors.blue, Colors.yellow, Colors.red],
    ...
    flagDescCs: 'Držte se dál – obtížně manévruji', flagDescPl: 'Zachowaj odstęp – manewruję z trudnością', flagDescEl: 'Κρατηθείτε μακριά – ελίσσομαι με δυσκολία', flagDescHr: 'Držite se podalje – teško manevriram'),
  (letter: 'E', nato: 'Echo',     morse: '·',      flagColors: [Colors.blue],
    ...
    flagDescCs: 'Měním kurz doprava', flagDescPl: 'Zmieniam kurs w prawo', flagDescEl: 'Αλλάζω πορεία δεξιά', flagDescHr: 'Mijenjam kurs udesno'),
  (letter: 'F', nato: 'Foxtrot',  morse: '··−·',   flagColors: [Colors.white, Colors.red, Colors.white],
    ...
    flagDescCs: 'Jsem neschopný manévru – kontaktujte mě', flagDescPl: 'Jestem niezdolny do manewru – skontaktuj się ze mną', flagDescEl: 'Είμαι ακυβέρνητος – επικοινωνήστε μαζί μου', flagDescHr: 'Onesposobljen sam – stupite u vezu sa mnom'),
  (letter: 'G', nato: 'Golf',     morse: '−−·',    flagColors: [Colors.yellow, Colors.blue],
    ...
    flagDescCs: 'Potřebuji lodivoda', flagDescPl: 'Potrzebuję pilota', flagDescEl: 'Χρειάζομαι πλοηγό', flagDescHr: 'Trebam peljara'),
  (letter: 'H', nato: 'Hotel',    morse: '····',   flagColors: [Colors.white, Colors.red],
    ...
    flagDescCs: 'Lodivod na palubě', flagDescPl: 'Pilot na pokładzie', flagDescEl: 'Πλοηγός στο σκάφος', flagDescHr: 'Peljar je na brodu'),
  (letter: 'I', nato: 'India',    morse: '··',     flagColors: [Colors.yellow, Colors.black],
    ...
    flagDescCs: 'Měním kurz doleva', flagDescPl: 'Zmieniam kurs w lewo', flagDescEl: 'Αλλάζω πορεία αριστερά', flagDescHr: 'Mijenjam kurs ulijevo'),
  (letter: 'J', nato: 'Juliet',   morse: '·−−−',   flagColors: [Colors.blue, Colors.white],
    ...
    flagDescCs: 'Požár a nebezpečný náklad – držte se dál', flagDescPl: 'Pożar i niebezpieczny ładunek – zachowaj odstęp', flagDescEl: 'Φωτιά και επικίνδυνο φορτίο – κρατηθείτε μακριά', flagDescHr: 'Požar i opasan teret – držite se podalje'),
  (letter: 'K', nato: 'Kilo',     morse: '−·−',    flagColors: [Colors.blue, Colors.yellow],
    ...
    flagDescCs: 'Chci komunikovat', flagDescPl: 'Chcę się porozumieć', flagDescEl: 'Θέλω να επικοινωνήσω', flagDescHr: 'Želim stupiti u vezu'),
  (letter: 'L', nato: 'Lima',     morse: '·−··',   flagColors: [Colors.yellow, Colors.black],
    ...
    flagDescCs: 'Okamžitě zastavte své plavidlo', flagDescPl: 'Natychmiast zatrzymaj swoją jednostkę', flagDescEl: 'Σταματήστε αμέσως το σκάφος σας', flagDescHr: 'Odmah zaustavite plovilo'),
  (letter: 'M', nato: 'Mike',     morse: '−−',     flagColors: [Colors.white, Colors.blue],
    ...
    flagDescCs: 'Moje plavidlo stojí', flagDescPl: 'Moja jednostka stoi', flagDescEl: 'Το σκάφος μου είναι σταματημένο', flagDescHr: 'Moje plovilo je zaustavljeno'),
  (letter: 'N', nato: 'November', morse: '−·',     flagColors: [Colors.blue, Colors.white],
    ...
    flagDescCs: 'Ne / Nesouhlasím', flagDescPl: 'Nie / Przeczę', flagDescEl: 'Όχι / Αρνητικό', flagDescHr: 'Ne / Niječno'),
  (letter: 'O', nato: 'Oscar',    morse: '−−−',    flagColors: [Colors.red, Colors.yellow],
    ...
    flagDescCs: 'Muž přes palubu', flagDescPl: 'Człowiek za burtą', flagDescEl: 'Άνθρωπος στη θάλασσα', flagDescHr: 'Čovjek u moru'),
  (letter: 'P', nato: 'Papa',     morse: '·−−·',   flagColors: [Colors.blue, Colors.white],
    ...
    flagDescCs: 'Všichni na palubu – vyplouvám na moře', flagDescPl: 'Wszyscy na pokład – wypływam w morze', flagDescEl: 'Όλοι στο σκάφος – αποπλέω', flagDescHr: 'Svi na brod – isplovljavamo'),
  (letter: 'Q', nato: 'Quebec',   morse: '−−·−',   flagColors: [Colors.yellow],
    ...
    flagDescCs: 'Loď je zdravá – žádám volný přístup', flagDescPl: 'Statek zdrowy – proszę o wolną praktykę', flagDescEl: 'Το πλοίο είναι υγιές – ζητώ ελεύθερη πρατίκα', flagDescHr: 'Brod je zdrav – tražim slobodan promet'),
  (letter: 'R', nato: 'Romeo',    morse: '·−·',    flagColors: [Colors.red, Colors.yellow, Colors.red],
    ...
    flagDescCs: '(Bez standardního významu ICS)', flagDescPl: '(Bez standardowego znaczenia ICS)', flagDescEl: '(Χωρίς τυπική σημασία ICS)', flagDescHr: '(Nema standardnog ICS značenja)'),
  (letter: 'S', nato: 'Sierra',   morse: '···',    flagColors: [Colors.white, Colors.blue],
    ...
    flagDescCs: 'Motory plnou vzad', flagDescPl: 'Maszyny cała wstecz', flagDescEl: 'Μηχανές ολοταχώς ανάποδα', flagDescHr: 'Strojevi punom snagom krmom'),
  (letter: 'T', nato: 'Tango',    morse: '−',      flagColors: [Colors.red, Colors.white, Colors.red],
    ...
    flagDescCs: 'Lovím v páru vlečnou sítí – držte se dál', flagDescPl: 'Prowadzę połów tuką parą – zachowaj odstęp', flagDescEl: 'Ψαρεύω με ζευγαρωτή τράτα – κρατηθείτε μακριά', flagDescHr: 'Bavim se koćarenjem u paru – držite se podalje'),
  (letter: 'U', nato: 'Uniform',  morse: '··−',    flagColors: [Colors.red, Colors.white],
    ...
    flagDescCs: 'Míříte do nebezpečí', flagDescPl: 'Zmierzasz ku niebezpieczeństwu', flagDescEl: 'Οδεύετε προς κίνδυνο', flagDescHr: 'Plovite u opasnost'),
  (letter: 'V', nato: 'Victor',   morse: '···−',   flagColors: [Colors.white, Colors.red],
    ...
    flagDescCs: 'Potřebuji pomoc', flagDescPl: 'Potrzebuję pomocy', flagDescEl: 'Χρειάζομαι βοήθεια', flagDescHr: 'Trebam pomoć'),
  (letter: 'W', nato: 'Whiskey',  morse: '·−−',    flagColors: [Colors.red, Colors.white],
    ...
    flagDescCs: 'Potřebuji lékařskou pomoc', flagDescPl: 'Potrzebuję pomocy medycznej', flagDescEl: 'Χρειάζομαι ιατρική βοήθεια', flagDescHr: 'Trebam liječničku pomoć'),
  (letter: 'X', nato: 'X-ray',    morse: '−··−',   flagColors: [Colors.blue, Colors.white],
    ...
    flagDescCs: 'Zastavte – sledujte mé signály', flagDescPl: 'Zatrzymaj się – obserwuj moje sygnały', flagDescEl: 'Σταματήστε – προσέξτε τα σήματά μου', flagDescHr: 'Stanite – pratite moje signale'),
  (letter: 'Y', nato: 'Yankee',   morse: '−·−−',   flagColors: [Colors.yellow, Colors.red],
    ...
    flagDescCs: 'Vleču kotvu', flagDescPl: 'Kotwica pełznie', flagDescEl: 'Σέρνω άγκυρα', flagDescHr: 'Sidro ore'),
  (letter: 'Z', nato: 'Zulu',     morse: '−−··',   flagColors: [Colors.black, Colors.yellow],
    ...
    flagDescCs: 'Potřebuji remorkér', flagDescPl: 'Potrzebuję holownika', flagDescEl: 'Χρειάζομαι ρυμουλκό', flagDescHr: 'Trebam tegljač'),
];
...
const _dayShapes = [
  (
    ...
    titlePl: 'Czarna kula', titleEl: 'Μαύρη μπάλα (σφαίρα)', titleHr: 'Crna kugla',
  ...
  (
    ...
    titlePl: 'Dwie kule pionowo', titleEl: 'Δύο μπάλες κατακόρυφα', titleHr: 'Dvije kugle okomito',
  ...
  (
    ...
    titlePl: 'Kula – romb – kula', titleEl: 'Μπάλα – ρόμβος – μπάλα', titleHr: 'Kugla – romb – kugla',
  ...
  (
    ...
    titlePl: 'Romb', titleEl: 'Ρόμβος', titleHr: 'Romb',
  ...
  (
    ...
    titlePl: 'Stożek wierzchołkiem w dół', titleEl: 'Κώνος με κορυφή προς τα κάτω', titleHr: 'Stožac vrhom prema dolje',
  ...
  (
    ...
    titlePl: 'Dwa stożki wierzchołkami do siebie', titleEl: 'Δύο κώνοι με κορυφές μαζί', titleHr: 'Dva stošca spojena vrhovima',
  ...
  (
    ...
    titlePl: 'Walec', titleEl: 'Κύλινδρος', titleHr: 'Valjak',
  ...
  (
    ...
    titlePl: 'Trzy kule pionowo', titleEl: 'Τρεις μπάλες κατακόρυφα', titleHr: 'Tri kugle okomito',
